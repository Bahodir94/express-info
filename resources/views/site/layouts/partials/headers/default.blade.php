        ...
        <div class="header-wrap">
            ...
            @guest
                <div class="mobile-header-right">
                    <a href="{{ route('site.tenders.common.create') }}"><i class="fas fa-plus-circle"></i> Добавить
                        заказ</a>
                </div>
            @else
    ...
    <div class="menu-mobile-content">
        ...
        <div class="menu-mobile">
            <ul class="main-menu-mobile">
                ...
                <li>
                    <div class="row">
                        <div class="col-10"><a class="style_a" href="{{ route('site.tenders.index') }}">Конкурсы</a>
                        </div>
                        <a class="text-left" data-toggle="collapse" href="#sub-1" aria-expanded="false"
                           aria-controls="sub-1" style="color:#383838;">
                            <div class="col-2"><i class="fas fa-chevron-right" style="transform: rotate(90deg);"></i>
                            </div>
                        </a></div>
                                    ...
                                    <div class="collapse" id="a{{ $need->id }}">
                                        <ul class="main-menu-mobile">
                                            @foreach($need->menuItems as $item)
                                                <li>
                                                    <div class="row">
                                                        <div class="col-9"><a class="style_a"
                                                                              href="{{ route('site.tenders.category', $item->ru_slug) }}">{{ $item->ru_title }}</a>
                                                        </div>
                                                        <a class="text-left" data-toggle="collapse"
                                                           href="#b{{ $item->id }}" aria-expanded="false"
                                                           aria-controls="b{{ $item->id }}" style="color:#383838;">
                                                            <div class="col-3"><i class="fas fa-chevron-right"
                ...
                <li>
                    <div class="row">
                        <div class="col-10"><a class="style_a"
                                               href="{{ route('site.contractors.index') }}">Исполнители</a></div>
                        <a class="text-left" data-toggle="collapse" href="#sub-2" aria-expanded="false"
                           aria-controls="sub-2" style="color:#383838;">
                            <div class="col-2"><i class="fas fa-chevron-right" style="transform: rotate(90deg);"></i>
                            </div>
                        </a></div>
                                            ...
                                            @foreach($need->menuItems as $item)
                                                <li>
                                                    <div class="row">
                                                        ...
                                                        <a class="text-left" data-toggle="collapse"
                                                           href="#c{{ $item->id }}" aria-expanded="false"
                                                           aria-controls="c{{ $item->id }}" style="color:#383838;">
                                                            <div class="col-2"><i class="fas fa-chevron-right"
