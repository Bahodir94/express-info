                    ...
                    @foreach($user->ownedTenders as $tender)
                        <tr class="my-job-item">
                            <td>
                                ...
                                <div class="meta-job"><span> <i class="fas fa-calendar-alt"></i> Опубликован: @if ($tender->publish) {{ $tender->published_at->format('d.m.Y') }} @else На модерации @endif</span><span> <i
