    ...
    <form action="" method="post">
        ...
        <section class="box-admin edit-profile">
            ...
            <div class="description-box-admin">
                <p>Выберите в этом списке услуги, предоставляемые вами и укажите минимальные и максимальные цены на них. Ставьте реальные цены - не забывайте про конкуренцию на площадке.</p>
            </div>
