                                ...
                                <div class="job-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-10 job-info">
                                            <div class="text">
                                                <h3 class="title-job"><a href="{{ route('site.tenders.category', $tender->slug) }}">{{ $tender->title }}</a><span class="ml-2 tags"><a>@if (!$tender->checkDeadline() || $tender->contractor) Срок приёма заявок окончен @else Открыт @endif</a></span></h3>
                                                <div class="date-job">
