...
<head>
    ...
    <title>Создание корпоративных сайтов в Ташкенте</title>
    <link href=https://vid.uz/site/korp rel=canonical/>
    ...
    <script type=application/ld+json>
        {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://vid.uz/","name":"Главная"}},{"@type":"ListItem","position":2,"item":{"@id":"https://vid.uz/site","name":"Создание сайтов"}},{"@type":"ListItem","position":3,"item":{"@id":"https://vid.uz/site/korp","name":"Корпоративные сайты"}}]}
    </script>
</head>
<body class="">
<div class=tm-page>
                                ...
                                <ul class="uk-nav uk-nav-primary uk-nav-center">
                                    ...
                                    <li class="uk-active uk-parent"><a href=/site>Создание сайтов</a>
                                        <ul class=uk-nav-sub>
                                            ...
                                            <li class=uk-active><a href=/site/korp>Корпоративные сайты</a></li>
                            ...
                            <div class="uk-grid-item-match uk-flex-middle uk-width-expand@xl">
                                <div class=uk-panel>
                                    <div><span
                                            ...
                                            style="opacity: 1;display: block;"><h1 class=uk-h6>РАЗРАБОТКА КОРПОРАТИВНЫХ САЙТОВ В ТАШКЕНТЕ</h1></span>
                                    </div>
                                    <div class="uk-text-large uk-margin uk-text-left@m uk-text-center"
                                         uk-parallax="y: 0,-20; opacity: 1,0; viewport: 0.9;"><p>Корпоративный сайт в
                                            наше время - это уже не просто сайт визитка - а мощный инструмент
                                            продвижения компании. Он позволяет предоставить всю информацию о компании и
                                            услугах, портфолио или публикациях компании. Тем самым показывая не только
                                            профессионализм и стиль компании, но и создавая удобство и пользу для
                                            клиентов.</p></div>
                                </div>
                            </div>
                        </div>
        ...
        <div class=uk-container>
                ...
                <div class="uk-grid-item-match uk-width-1-1@m">
                    <div class="uk-tile-default uk-grid-item-match">
                        <div class="uk-tile uk-background-norepeat uk-background-center-left uk-background-image@m"
                            ...
                            <div class="uk-heading-primary hedg uk-text-left@s uk-text-center"> Преимущества наших
                                сайтов
                            </div>
                        </div>
                    </div>
            ...
            <div class=uk-margin-large uk-grid>
                <div class=uk-width-1-1@m>
                    <div>
                        <div
                            class="uk-margin uk-text-left@s uk-text-center uk-grid-match uk-child-width-1-1 uk-child-width-1-1@s uk-child-width-1-2@m uk-grid-large uk-grid"
                            ...
                            <div class=uk-first-column>
                                <div class="el-item uk-panel">
                                    ...
                                    <div class="el-content uk-margin">Люди всегда строют свое первое впечатление по
                                        внешнему виду, и от того, на сколько ваш корпоративный сайт будет соответсвует
                                        его предпочтениям и вкусу, тем больше эффективность сайта.
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="el-item uk-panel">
                                    <div class="uk-h3 el-title uk-margin uk-heading-bullet"> Полезный функционал</div>
                                    <div class="el-content uk-margin">Отличие корпоративного сайта, от других типов
                                        рекламы в том, что люди сами ищут вас, ваш товар или услуги. И продумав
                                        дополнительные функции, которые упростят процесс работы с вашей компанией, вы
                        ...
                        <div class=uk-width-2-3@m>
                            ...
                            <div uk-scrollspy-class>
                                <div
                                    ...
                                    uk-scrollspy-class="" uk-grid="" data-id=page#46 style="">
                                    <div class=uk-first-column>
                                        <div uk-scrollspy-class=""
                        ...
                        <form enctype=multipart/form-data id=simplecallback-119
                            ...
                            <div class="form-group uk-width-auto@s"><input type=text name=simplecallback_username
                                ...
                                <input type="hidden" name="ed3313db60fa2b01f2f3d974c9d08645" value="1"/> <input
                                    type=hidden name=module_id value=119/> <input type=hidden name=Itemid value=147>
                                <input type=hidden name=simplecallback_page_title value="Корпоративные сайты"> <input
                                    type=hidden name=simplecallback_page_url value=https://vid.uz/site/korp> <input
                ...
                <div class="uk-grid-item-match uk-flex-middle uk-width-expand@m uk-width-1-2@s">
                    <div class=uk-panel>
                        ...
                        <div class="uk-margin uk-text-left@m uk-text-center"
                             uk-parallax="y: 20,0; opacity: 0,1; viewport: 0.7;">Менеджер продаж
                        </div>
  ...
  " method=post data-simplecallback-form data-simplecallback-form-overlayed style='display: none;'>
                            <div class=contact-form__container>
                                ...
                                <div class=form-group><input type=text name=simplecallback_username
                                        ...
                                        type=hidden name=module_id value=161/> <input type=hidden name=Itemid value=147>
                                    <input type=hidden name=simplecallback_page_title value="Корпоративные сайты">
                                    <input type=hidden name=simplecallback_page_url value=https://vid.uz/site/korp>
