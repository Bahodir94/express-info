...
@section('content')
    @include('admin.components.breadcrumb', [
        ...
        'lastTitle' => $service->ru_title
    ])

    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">{{ $service->ru_title }}</h3>
        </div>
        <form action="{{ route('admin.companies.update', $service->id) }}" method="post">
            @csrf
            @method('put')
                        ...
                        <div class="tab-pane active" id="wizard-simple-step1" role="tabpanel">
                            <div class="form-group @error('ru_title') is-invalid @enderror">
                                <div class="form-material floating">
                                    ...
                                    <input class="form-control" type="text" id="ru_title" name="ru_title" value="{{ $service->ru_title }}">
                                </div>
                        ...
                        <div class="tab-pane" id="wizard-simple-step2" role="tabpanel">
                            <div class="form-group @error('en_title') is-invalid @enderror">
                                <div class="form-material floating">
                                    ...
                                    <input class="form-control" type="text" id="en_title" name="en_title" value="{{ $service->en_title }}">
                                </div>
                        ...
                        <div class="tab-pane" id="wizard-simple-step3" role="tabpanel">
                            <div class="form-group @error('uz_title') is-invalid @enderror">
                                <div class="form-material floating">
                                    ...
                                    <input class="form-control" type="text" id="uz_title" name="uz_title" value="{{ $service->uz_title }}">
                                </div>
