    ...
    <div id="sidebar-scroll">
        ...
        <div class="sidebar-content">
                    ...
                    <ul class="list-inline mt-10">
                        ...
                        <li class="list-inline-item">
                            <form action="{{ route('admin.logout') }}" method="post">
                                @csrf
                                <button class="link-effect text-dual-primary-dark" style="background-color: transparent; border: none;"><i class="si si-logout"></i></button>
                            </form>
                        </li>
                    </ul>
                </div>
            ...
            <div class="content-side content-side-full">
                @include('admin.layouts.partials.sidebar_links')
            </div>
            <!-- END Side Navigation -->
        </div>
        <!-- Sidebar Content -->
