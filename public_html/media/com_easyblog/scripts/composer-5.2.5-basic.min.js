...
},getBlock:function(a){var b=s.find(EBD.block+"[data-uid="+a+"]");return b},getBlockUid:function(a){return a.attr("data-uid")||b.setBlockUid(a)},setBlockUid:function(b){return b.attr("data-uid")||function(){var c=a.uid();return b.attr("data-uid",c),c}()},updateBlockUid:function(a){a.removeAttr("data-uid"),b.setBlockUid(a)},getBlockType:function(b){return a(b).attr("data-type")},metas:{},getBlockMeta:function(c){return c instanceof a&&(c=b.getBlockType(c)),b.metas[c]||function(){var a=b.meta().where("type",c).val();
return a?b.metas[c]=JSON.parse(a):null}()},getBlockViewport:function(a){return b.immediateBlockViewport.inside(a)},getBlockContent:function(a){return b.immediateBlockContent.inside(a)},getBlockActions:function(a){return b.blockActions.inside(a)},setBlockContent:function(a,c){b.immediateBlockContent.inside(a).html(c.html())},getBlockFragment:function(c){var d=function(a){var c=b.getBlockType(a),d=b.getBlockHandler(c),e=b.createBlockContainer(c),f=d.toHTML(a);return a.is(EBD.nested)&&a.addClass(l),e.append(f),e
},e=d(c);return e.find(EBD.nestedBlock).each(function(){var b=a(this),c=d(b);b.replaceWith(c)}),e},getBlockHTML:function(a){return b.getBlockFragment(a).toHTML()},getBlockText:function(){},getBlockNest:function(a){return a.closest(EBD.nest)},getBlockNestType:function(a){return b.getBlockNest(a).data("type")},isBlock:function(a){return a.is(EBD.block)},isNestedBlock:function(a){return a.is(EBD.nestedBlock)},isRootBlock:function(a){return!b.isNestedBlock(a)},isStandaloneBlock:function(a){return a.is(EBD.standaloneBlock)
...
else{var i=blocks.getBlockContent(a);h.editableHtml=i.html()}return b.trigger("composerBlockExport",[a,h]),h},addBlock:function(a){b.root().append(a),b.initBlock(a)},removeBlock:function(c){b.trigger("composerBlockBeforeRemove",[c]),c.find(EBD.nestedBlock).each(function(){var c=a(this);b.removeBlock(c)}),c.remove(),b.trigger("composerBlockRemove",[c])},scrollTo:function(a){var b=t.viewport();t.viewportContent().stop(!0).scrollTo(a,500,{axis:"y",offset:{top:(b.height()-a.height())/-2,left:0}})},blockHandlers:{},loadBlockHandler:a.memoize(function(c){if(!c)return a.Deferred().reject(a.Exception("Invalid block type given."));
var d=b.getBlockMeta(c);if(!d)return a.Deferred().reject(a.Exception("Block of type '"+c+"' is not installed!"));var e=a.Deferred();return EasyBlog.require().script("composer/blocks/handlers/"+c).done(function(){var f="handler/"+c,g="EasyBlog.Controller.Composer.Blocks.Handlers."+a.String.capitalize(c),h={meta:d},i=b.addPlugin(f,g,h);b.blockHandlers[c]=i,EasyBlog.debug&&b.verifyBlockHandler(i),e.resolve(i,d)}).fail(function(){b.loadBlockHandler.reset(c),e.reject(a.Exception("Could not load block handler for "+c+"."))
}),e}),getBlockHandler:function(c){return c instanceof a&&(c=b.getBlockType(c)),b.blockHandlers[c]},verifyBlockHandler:function(b,c){for(var d,c=c||["activate","deactivate","construct","reconstruct","deconstruct","refocus","reset","populate","toHTML","toData","toText"],e=[];d=c.shift();)a.isFunction(b[d])||e.push(d);e.length>0&&console.warn("Block handler of type '%s' is missing the following method: %s.",b.options.meta.type,e.join(", "))},activateBlock:function(a){if(!b.workarea().hasClass("is-removing")){b.deactivateBlock(),t.manager().removeClass("is-composer-blocks-open"),b.menu().removeClass(p);
var c=b.getBlockType(a);b.loadBlockHandler(c).done(function(c){var d=[a,c];b.trigger("composerBlockBeforeActivate",d),b.initBlock(a),c.activate&&c.activate(a),c.refocus(a),b.trigger("composerBlockActivate",d)}).fail(function(a){b.trigger("composerBlockActivateError",[a])})}},deactivateBlock:function(a){if(a=a||b.getCurrentBlock(),a.length){var c=b.getBlockHandler(a);c&&c.deactivate&&c.deactivate(a),b.trigger("composerBlockDeactivate",[a,c])}},"{menu} mouseover":function(c){if(!c.data("uiDraggable")){var d=c.clone();
d.find(b.meta.selector).remove();var e=a("html").attr("dir"),f="ltr"==e?{right:165}:{left:165};c.draggable({helper:function(){return d.css({width:c.outerWidth(),height:c.outerHeight()})},cursorAt:f,appendTo:t.document.ghosts(),connectToSortable:EBD.root})}},selectBlock:function(a){b.menu().removeClass(p);var c=t.manager().hasClass(n),d=t.manager().hasClass(o);return d?(b.addToNextPosition(a),void 0):(a.addClass(p),t.manager().addClass(n),b.trigger("composerBlockMenuSelected",[a]),c||t.blocks.droppable.populateDropzones(),void 0)
},addToNextPosition:function(a){var c=b.getCurrentBlock(),d=a,e=d.is(b.menu);e&&(block=b.createBlockFromMenu(d)),c.after(block),b.drop(block),b.release(block),b.out(block),t.manager().removeClass(o),t.manager().removeClass("is-composer-blocks-open")},"{menu} touchend":function(){},"{menu} touchstart":function(){},"{menu} click":function(a){b.selectBlock(a)},"{menu} dragstart":function(a){b.drag(a),t.manager().addClass(m),b.view().parent().removeClass("open"),t.views.hide("blocks")},"{menu} dragstop":function(a){b.release(a),t.manager().removeClass(m)
},"{menu} dblclick":function(){},drag:function(a){b.workarea().addClass(j),a.is(b.menu)||(a.addClass(k),t.manager().removeClass("is-composer-blocks-open"),t.editor.selection.remove(),b.trigger("composerBlockDrag",[a]))},drop:function(a){a.is(b.menu)||(b.trigger("composerBlockBeforeDrop",[a]),a.addClass(f),b.trigger("composerBlockDrop",[a]),b.activateBlock(a))},release:function(a){b.workarea().removeClass(j),a.is(b.menu)||(a.removeClass(f).addClass(g).removeClassAfter(g+" "+k),b.trigger("composerBlockBeforeRelease",[a]),setTimeout(function(){b.trigger("composerBlockRelease",[a])
},1e3))},over:function(a){a.addClass(e),a.hasClass(l)&&b.nest.of(a).addClass(e),b.block.of(a).addClass(e)},out:function(a){a.removeClass(e),a.hasClass(l)&&b.nest.of(a).removeClass(e),b.block.of(a).removeClass(e)},highlight:function(a){b.root().addClass(q),a.addClass(i)},unhighlight:function(a){b.root().removeClass(q),a.removeClass(i)},dataset:{},"{block} click":function(a,c){c.clickHandled||b.refocusing||b.workarea().hasClass("is-resizing")||(c.clickHandled=!0,a.is(b.menu)||a.hasClass("active")||b.activateBlock(a))
...
return void 0===c?f:f[c]},duplicateChildBlocksData:function(c,d){var e=b.getChildBlocks(d);e&&a.each(e,function(d,e){var e=a(e),f=b.getBlockUid(e),g=b.data(e),h=c.find("[data-uid="+f+"]");b.updateBlockUid(h);var i=a.extend(!0,{},g);b.setBlockData(h,i)})},setBlockData:function(a,c){uid=b.getBlockUid(a),b.dataset[uid]=c},setData:function(c,d,e){if(void 0===c)return b.dataset;var f=parseInt(c);return isNaN(f)?f=b.getBlockUid(c):c=b.getBlock(c),a.isPlainObject(d)&&void 0===e?a.extend(b.dataset[f],d):b.dataset[f][d]=e
},getMechanics:function(){return t.settings.get("blocks.mechanics")},setMechanics:function(a){t.settings.set("blocks.mechanics",a),b.trigger("composerBlockMechanicsChange",a)},"{mechswitch} click":function(a){b.mechswitch().removeClass("btn-primary"),a.addClass("btn-primary"),b.setMechanics(a.attr("data-value"))},"{block} mouseover":function(a,c){c.hovered||(c.hovered=!0,b.trigger("composerBlockHoverIn",[a]))},"{block} mouseout":function(a){b.trigger("composerBlockHoverOut",[a])},"{self} composerDocumentInit":function(){var c=b.getAllBlocks();
c.each(function(){var c=a(this);b.initBlock(c)})},"{self} composerDocumentBlur":function(){return b.refocusing?(b.refocusing=!1,void 0):(b.deactivateBlock(),void 0)},"{self} click":function(c,d){var e=b.view().parent().hasClass("open");if(e){var f=a(d.target);f.is("[data-toolbar-blocks]")||f.parents("[data-eb-composer-blocks]").length>0||b.view().parent().removeClass("open")}},"{self} keyup":function(a,c){var d=b.view().parent().hasClass("open");d&&27==c.keyCode&&b.view().parent().removeClass("open")},"{editableContent} focusin":function(a,c){c.focusHandled||b.refocusing||t.document.isLegacy()||(b.refocusing=!0,c.focusHandled=!0,setTimeout(function(){var c=(b.workarea(),t.editor.selection.get()),d=c.focusNode;
if(!d)return b.refocusing=!1,void 0;var e=b.block.of(d);if(!e.length)return b.refocusing=!1,void 0;if(!e.hasClass(h)){e.addClass(h);try{if(e.hasClass("active")){var f=b.getBlockHandler(e);f.refocus(e)}else b.activateBlock(e)}catch(g){}e.removeClass(h),setTimeout(function(){b.refocusing=!1},100)}},1))}}}),b.resolve()})}),EasyBlog.module("composer/blocks/dimensions",function(){var b=this,c=function(a){return a.toString().match("%")?"%":"px"};EasyBlog.require().script("composer/vendors/nouislider").done(function(a){EasyBlog.Controller("Composer.Blocks.Dimensions",{elements:["[data-eb-block-dimensions-{field}]","[data-eb-block-dimensions-field-container] [data-eb-{numslider-toggle|numslider-widget|numslider-value|numslider-input|numslider-units|numslider-unit|numslider-current-unit}]"],defaultOptions:a.extend({},EBD.selectors)},function(b,d,e,f,g,h){return{init:function(){g=b.blocks,f=g.composer,h=a()
...
},"{self} composerBlockMenuSelected":function(a,c,d){b.selectedBlock=d},"{self} composerBlockInit":function(c,d,e){var f=g.getBlockType(e);if("image"==f){var h=a.extend(!0,{},b.draggableOptions,{cursorAt:{top:0,left:0}});return e.draggable(h),void 0}e.draggable(b.draggableOptions)},populateDropzones:function(){b.nest().each(function(){var c=a(this),d=c.data("type");if("block"==d&&(c.prepend(b.createNestedDropzone()),c.find(EBD.childBlock).each(function(){var c=a(this);c.after(b.createNestedDropzone())})),"content"==d){var e=g.nestable.availablePositions(c);
a.each(e,function(a,d){c.prepend(b.createNestedDropzone(d))})}});var c=g.getRootBlocks();c.each(function(c){var d=a(this);0==c&&d.before(b.createDropzone()),d.hasClass("is-sort-item")||d.after(b.createDropzone())}),c.length<1&&b.root().append(b.createDropzone()),b.dropzone().droppable(b.droppableOptions)},createDropzone:function(){return a(b.dropzonePlaceholder).clone()},createNestedDropzone:function(a){var c=b.createDropzone().addClass("is-nested");return a&&c.addClass("nest-"+a).data("position",a),c},destroyDropzones:function(){b.dropzone().remove()
},"{block} dragstart":function(a,c,d){c.stopPropagation(),d.helper.addClass("is-helper").css({width:a.width(),height:a.height()}),g.drag(a),h=a,b.populateDropzones(),f.manager().addClass("is-resizing")},"{blocks.menu} dragstart":function(a){var e=f.manager().hasClass("is-dropping-block");e||b.populateDropzones(),h=a,f.manager().addClass("is-resizing")},"{mediaFile} dragstart":function(){b.populateDropzones(),h=a(),f.manager().addClass("is-resizing")},"{dropzone} click":function(a){if(!f.manager().hasClass("is-dragging-block")){b.isDropping=!0;
var d=b.selectedBlock;d.removeClass("hide").removeClass("is-sort-item"),b.dropBlock(a,d),setTimeout(function(){b.isDropping=!1,b.dropStop(),b.selectedMenu=null,b.selectedBlock=null,f.manager().removeClass("is-dropping-block"),f.manager().removeClass("is-moving-block")},0)}},"{dropzone} mouseenter":function(a){a.addClass("is-receiving")},"{dropzone} mouseleave":function(a){a.removeClass("is-receiving")},"{dropzone} dropover":function(a,c,d){g.over(a),b.lastDropzone=a;var e=a.data("position");d.helper.addClass("is-sending"),e&&b.nest.of(a).data("snappedPosition",e)
},"{dropzone} dropout":function(a,c,d){b.lastDropzone=null,g.out(a),d.helper.removeClass("is-sending")},isDropping:!1,lastDropzone:null,dropBlock:function(a,d){var e=d,h=d.is(g.menu);h&&(e=g.createBlockFromMenu(d));var i=d.is(b.mediaFile);i&&(e=g.createBlockFromMediaFile(d));var j=f.manager().hasClass("is-moving-block"),k=f.manager().hasClass("is-dropping-block");if(j||k){var l=g.getBlockNest(a),m=a.data("position");l.data("snappedPosition",m)}var n=a.hasClass(c);return a.replaceWith(e),(h||i||j||k)&&(g.drop(e),g.release(e),g.out(e),n&&e.addClass(c)),f.manager().removeClass("is-dropping-block"),e
},dropStop:function(){setTimeout(function(){f.manager().hasClass("is-dropping-block")||b.destroyDropzones()},1),f.manager().removeClass("is-resizing")},"{dropzone} drop":function(a,d,e){if(!b.isDropping){b.isDropping=!0;var f=e.draggable,g=a.hasClass(c);block=b.dropBlock(a,f),setTimeout(function(){b.isDropping=!1,g&&block.addClass(c)},0)}},"{block} dragstop":function(a){a.removeClass("hide"),g.drop(a),g.release(a),g.out(a),b.dropStop()},"{blocks.menu} dragstop":function(a,c,d){if(b.isDropping||!b.lastDropzone)return b.dropStop(),void 0;
var e=d.helper;b.dropBlock(b.lastDropzone,e),b.dropStop()},"{mediaFile} dragstop":function(a,c,d){if(b.isDropping||!b.lastDropzone)return b.dropStop(),void 0;var e=d.helper;b.dropBlock(b.lastDropzone,e),b.dropStop()},"{self} composerDocumentScroll":function(b,c){var d=h.data("ui-draggable");a.ui.ddmanager.prepareOffsets(d,c)},"{dropzone} dropdeactivate":function(a){g.out(a)}}}),b.resolve()})}),EasyBlog.module("composer/blocks/font",function(a){var b=this;EasyBlog.require().script("composer/vendors/colorpicker","composer/vendors/nouislider").done(function(){EasyBlog.Controller("Composer.Blocks.Font",{elements:[".eb-composer-fieldset[data-name=font] [data-eb-{font-color-menu|font-family-menu|font-size-menu|font-color-content|font-color-picker|font-family-content|font-size-content|font-color-caption|font-family-caption|font-size-caption|font-family-option|font-format-option}]",".eb-composer-fieldset[data-name=font] [data-eb-{numslider-toggle|numslider-widget|numslider-value|numslider-input|numslider-units|numslider-unit|numslider-current-unit}]",".eb-composer-fieldset[data-name=font] [data-eb-{colorpicker|colorpicker-toggle}]"],defaultOptions:a.extend({fontSizeUnits:{px:{start:12,step:2,range:{min:8,max:72},pips:{mode:"values",density:4,values:[8,12,18,24,48,72]}},"%":{start:100,step:10,range:{min:0,max:200},pips:{mode:"positions",values:[0,50,100],density:10}}}},EBD.selectors)},function(b,c,d,e,f,g){return{init:function(){f=b.blocks,e=f.composer,g=a(),b.initFontFormatting(),b.initFontColor()
},"{self} composerBlockActivate":function(a,c,d){g=d,b.populate(d)},populate:function(a){var c=f.getBlockMeta(a),d=c.properties.fonts;e.panels.fieldset.get("font").toggle(d),d&&(b.populateFontColor(a),b.populateFontFamily(a),b.populateFontSize(a),b.populateFontFormatting(a))},hideFontFieldset:function(){e.panels.fieldset.get("font").hide()},initFontColor:function(){b.fontColorPicker().colorpicker()},populateFontColor:function(a){var c=a.css("color");b.updateFontColorUI(c)},setFontColor:function(a,c){a.css("color",c),b.updateFontColorUI(c)
},updateFontColorUI:function(a){b.updatingFontColorUI=!0,a||(a=g.css("color")||"#000"),b.fontColorCaption().css("backgroundColor",a),b.fontColorPicker().colorpicker("setColor",a),b.updatingFontColorUI=!1},removeFontColor:function(a){b.setFontColor(a,"")},populateFontFamily:function(a){var c=a[0].style.fontFamily;b.updateFontFamilyUI(c)},setFontFamily:function(c,e){b.unpreviewFontFamily(c);var f=a.Event("composerBlockFontFamilyChange");f.fontFamily=e,d.trigger(f,[e,c]),b.updateFontFamilyUI(f.fontFamily),f.isDefaultPrevented()||c.css("fontFamily",f.fontFamily)
},updateFontFamilyUI:function(a){var c=b.fontFamilyOption().removeClass("active").where("value",'"'+a+'"').addClass("active"),d=c.length>0?c.html():a.split(",")[0];b.fontFamilyCaption().html(d)},previewFontFamily:function(b,c){var e=b.data("originalFontFamily")||g[0].style.fontFamily,f=a.Event("composerBlockFontFamilyPreview");f.originalFontFamily=e,f.fontFamily=c,d.trigger(f,[c,e,b]),b.data("originalFontFamily",f.originalFontFamily),f.isDefaultPrevented()||b.css("fontFamily",f.fontFamily)},unpreviewFontFamily:function(b){var c=b.data("originalFontFamily"),e=a.Event("composerBlockFontFamilyUnpreview");
return e.originalFontFamily=c,d.trigger(e,[c,b]),b.removeData("originalFontFamily"),e.isDefaultPrevented()?void 0:(b.css("fontFamily",e.originalFontFamily),void 0)},populateFontSize:function(a){var c=a.css("fontSize");b.updateFontSizeUI(c)},setFontSize:function(c,d){if(a.isNumeric(d)){var e=b.getFontSizeUnit();d+=e}c.css("fontSize",d),b.updateFontSizeUI(d||c.css("fontSize")),d?b.setLineHeight(c,"120%"):b.removeLineHeight(c)},updateFontSizeUI:function(a){b.updatingFontSizeUI=!0;var c=Math.abs(a.replace(/\%|px/gi,""));
unit=a.match("%")?"%":"px",b.getFontSizeUnit()!==unit&&b.setFontSizeUnit(unit),b.fontSizeCaption().html(a),b.numsliderCurrentUnit().html(unit),b.numsliderUnit().removeClass("active").where("unit",'"'+unit+'"').addClass("active"),b.numsliderWidget().val(c),b.numsliderInput().val(c),b.updatingFontSizeUI=!1},removeFontSize:function(a){b.setFontSize(a,"")},getFontSizeUnit:function(){return b.fontSizeContent().data("unit")||"%"},setFontSizeUnit:function(a){b.fontSizeContent().data("unit",a);var d=c.fontSizeUnits[a];
...
},"{numsliderWidget} set":function(a,c,d){b.updatingFontSizeUI||b.setFontSize(g,Math.abs(d))},"{numsliderInput} input":function(c){if(!b.updatingFontSizeUI){var d=Math.abs(a.trim(c.val()));b.setFontSize(g,d)}},"{numsliderUnit} click":function(a){var c=a.data("unit");b.setFontSizeUnit(c)},"{numsliderToggle} click":function(){b.removeFontSize(g)},"{self} composerBlockRemove":function(){b.hideFontFieldset()},"{self} composerBlockDeactivate":function(){b.hideFontFieldset()}}}),b.resolve()})}),EasyBlog.module("composer/blocks/guide",function(a){var b=this;
...
},isUrlValid:function(a){if(""==a)return!1;var b=/^(http|https):\/\/www\.dailymotion\.com\/video\/(.*)$/,c=b.test(a);return c},loading:function(){var a=f.getBlockContent(h),c=b.loader.inside(a),d=b.form.inside(a);b.isLoading?(c.addClass("hidden"),d.removeClass("hidden"),b.isLoading=!1):(c.removeClass("hidden"),d.addClass("hidden"),b.isLoading=!0)},crawl:function(a,c){var d=f.data(c),e=f.getBlockContent(c),g=c.data("overlay");g&&g.element().empty(),b.loading(),EasyBlog.ajax("site/views/crawler/crawl",{url:a}).done(function(e){var f=e[a];
...
var i=b.getOverlay(h);i.refresh()}},250),"{updateUrl} click":function(){var d=b.url().val(),g=(f.data(h),f.getBlockContent(h));return b.isUrlValid(d)?(b.crawl(d,h),void 0):(b.errorMessage.inside(g).removeClass("hide"),void 0)}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/facebook",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Handlers.Facebook",{defaultOptions:{"{form}":"> [data-fb-form]","{embed}":"[data-fb-embed]","{source}":"[data-fb-source]","{preview}":"[data-fb-preview]","{input}":"[data-fb-source-input]","{update}":"[data-fb-update]","{errorMessage}":"[data-fb-error]"}},function(b,c,d,e,f,g,h){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a()
...
var q=b.createGalleryImage(a,j);m.html(q);var r=mediaManager.getVariation(k,"icon");i.items[e]={title:j.title,iconUrl:r.url},p.normalizeImageSize(q),a.is(n)&&b.populateList(a)},reconstruct:function(a){a.editable(!1);{var c=b.galleryUploadPlaceholder.inside(a);mediaUploader.register(c)}b.populateDataItems(a)},deconstruct:function(a){var c=l.data(a),d=l.getBlockContent(a),e=b.galleryContainer.inside(a);b.galleryItemPlaceholder.inside(e).remove(),b.galleryMenuItemPlaceholder.inside(e).remove();var f=b.galleryItem.inside(e),g=f.where("id",c.primary);
f.removeClass("active"),g.addClass("active"),b.galleryMenuItem.inside(e).removeClass("active").where("id",c.primary).addClass("active"),EasyBlog.ImageGallery.setLayout(e);var h=b.getGalleryItemIndex(a,g);0>h&&(h=0);var i=b.galleryViewport.inside(e),j=0;return 0!=h&&(j=-100*h),i.css("left",j+"%"),d.html(e),a},refocus:function(){},reset:function(){},populate:function(a){b.populateDataItems(a),b.populateRatio(a),b.populateResizeStrategy(a),b.populateList(a)},populateDataItems:function(c){var d=l.data(c);a.each(d.itemsKeyArray,function(a,b){d.items[b]=d.itemsArray[a]
}),b.uploadedItems=d.itemsArray.length},toData:function(a){var b=l.data(a);b.itemsArray=[],b.itemsKeyArray=[];for(var c in b.items)b.items.hasOwnProperty(c)&&(b.itemsArray.push(b.items[c]),b.itemsKeyArray.push(c));return b},toText:function(){},toHTML:function(a){var c=a.clone(),d=b.deconstruct(c),e=l.getBlockContent(d);return e.html()},toLegacyHTML:function(b){var c=[];a.each(b,function(a,b){var d=JSON.parse(b.meta.params),e={namespace:b.uri,caption_text:d.caption_text};c.push(e)});var e="[embed=gallery]"+JSON.stringify(c)+"[/embed]";
return e},getGalleryItemTemplate:function(){return a(m.galleryItem)},getGalleryMenuItemTemplate:function(b){var c=a(m.galleryMenuItem);return c.data("id",b),c},createGalleryListItem:function(){return a(m.galleryListItem)},createGalleryPlaceholder:function(){return a(m.galleryPlaceholder)},createGalleryImage:function(a,b){var c=l.data(a),d=JSON.parse(b.params),e=b.uri,f=mediaManager.getVariation(e,"medium"),g=f.width,i=f.height,j=g/i,k={uri:e,url:f.url,key:f.key,mode:"advanced",mode_lock:!0,fluid:!0,width:"100%",width_lock:!0,height:"100%",height_lock:!0,ratio:h(c.ratio),strategy:c.strategy,element_ratio:j,natural_width:g,natural_height:i,natural_ratio:j,caption_enabled:!0,caption_text:d.caption_text,link_enabled:!1,style_enabled:!1,popup_enabled:!1,variation:"large"},m=l.constructNestedBlock("image",k).addClass("is-isolated");
...
n.attr("data-id",g).insertBefore(k).addClass("active"),mediaUploader.addItem(e,m),i.removeClass(c)}),EasyBlog.ImageGallery.setLayout(i)},uploadedItems:0,addedItems:0,"{galleryUploadPlaceholder} mediaUploaderFileUploaded":function(a,c,d,e,f){void 0===p&&(p=l.getBlockHandler("image"));var g=e.id,h=f.response,i=h.media,j=i.meta,k=l.block.of(a),f=l.data(k);setTimeout(function(){var c=b.galleryItem().where("fileId",g).removeAttr("data-file-id"),d=c.attr("data-id");mediaUploader.removeItem(e,c);var h=b.createGalleryImage(k,j);
c.html(h);var i=j.uri,l=mediaManager.getVariation(i,"icon");f.items[d]={title:j.title,iconUrl:l.url},p.normalizeImageSize(h),k.is(n)&&b.populateList(k),0==b.uploadedItems&&b.setPrimary(d),b.uploadedItems+=1;var m=b.uploadedItems/b.addedItems*100;a.find(b.galleryProgressBar).css("width",m+"%"),100==m&&setTimeout(function(){a.find(b.galleryProgressBar).css("width","0%"),b.uploadedItems=0,b.addedItems=0,a.removeClass("state-uploading")},1e3)},600)},setPrimary:function(a){var c=b.galleryItem().where("id",a),d=b.galleryMenuItem().where("id",a),e=l.block.of(c),f=l.data(e);
f.primary=a,b.populateList(e),b.galleryMenuItem.inside(e).removeClass("active"),d.addClass("active")},setRatio:function(c,d){var e=l.data(c);e.ratio=d;var f=b.galleryStage.inside(c);f.css("padding-top",j(d));var g=b.galleryImage.inside(c);g.each(function(){var b=a(this);p.setImageRatio(b,h(d))})},updateRatio:function(a,c){b.setRatio(a,c),b.populateRatio(a)},populateRatio:function(a){var c=l.data(a),d=c.ratio;b.ratioLabel().html(d)},"{ratioButton} click":function(){b.sizeFieldset().switchClass(d)},"{ratioCustomizeButton} click":function(){b.sizeFieldset().switchClass(e)
},"{ratioCancelButton} click":function(){b.sizeFieldset().removeClass(d)},"{ratioCancelCustomButton} click":function(){b.sizeFieldset().switchClass(d)},"{ratioOkCustomButton} click":function(){b.sizeFieldset().removeClass(e)},"{ratioUseCustomButton} click":function(){var c=b.ratioInput(),d=f(c.val());0!=d&&(b.updateRatio(n,d),b.ratioSelection().removeClass("active"),b.sizeFieldset().removeClass(e))},"{ratioSelection} click":function(a){b.ratioSelection().removeClass("active"),a.addClass("active"),b.sizeFieldset().removeClass(d);
var c=a.data("value");b.updateRatio(n,c)},setResizeStrategy:function(c,d){var e=l.data(c);e.strategy=d;var f=b.galleryImage.inside(c);f.each(function(){var c=a(this);void 0===p&&(p=l.getBlockHandler("image")),p.resizeToViewport(c,d)})},updateResizeStrategy:function(a,c){b.setResizeStrategy(a,c),b.populateResizeStrategy(a)},populateResizeStrategy:function(a){var c=l.data(a),d=c.strategy;b.strategyMenuItem().removeClass("active").where("strategy",d).addClass("active")},"{strategyMenuItem} click":function(a){var c=a.data("strategy");
b.updateResizeStrategy(n,c)},listItems:{},populateList:function(c){var d=l.data(c),e=b.galleryItem.inside(c),f=[];e.each(function(){var c=a(this),e=c.attr("data-id"),g=d.items[e];if(g){var h=b.galleryImage.inside(c);if(h.length){var i=b.listItems[e];i||(i=b.createGalleryListItem(),i.attr("data-id",e),b.listItemTitle.inside(i).text(g.title),b.listItemIcon.inside(i).attr("src",g.iconUrl),b.listItems[e]=i);var j=e==d.primary;i.toggleClass("is-primary",j).toggleClass("active",c.hasClass("active")),f.push(i)}}}),b.itemsFieldset().toggleClass("is-empty",!f.length),b.listItemGroup().empty().append(f)
},"{listItem} click":function(a){var c=a.data("id");b.listItem().removeClass("active"),a.addClass("active");var d=b.galleryItem().where("id",c),e=b.getGalleryItemIndex(n,d),f=b.galleryContainer.of(d);EasyBlog.ImageGallery.go(f,e)},getGalleryItemIndex:function(a,c){var d=b.galleryViewport.of(c),e=d.find(b.galleryItem.selector),f=e.index(c);return f},"{listItemDeleteButton} click":function(){var c=b.listItem(".active");if(c.length){var d=c.data("id"),e=b.galleryItem().where("id",d),f=e.prev();f.length&&(f=f.next());
var g=l.block.of(e);e.remove();var h=b.galleryMenuItem().where("id",d);h.remove();var i=b.galleryContainer.inside(g),j=b.getGalleryItemIndex(f);EasyBlog.ImageGallery.setLayout(i),EasyBlog.ImageGallery.go(i,j),b.populateList(g)}},"{listItemPrimaryButton} click":function(){var c=b.listItem(".active");if(c.length){var d=c.data("id");b.setPrimary(d)}},hasThumbnails:function(){return!1},"{galleryBrowseButton} mediaSelect":function(a,c,d){"image"==d.meta.type&&b.constructGallery(n,[d])},"{self} mediaInsertGallery":function(a,c,d){if(k.document.isLegacy()){var e=b.toLegacyHTML(d);
return k.document.insertContent(e),void 0}var f=l.constructBlock("gallery",d);l.addBlock(f),b.constructGallery(f,d)},"{self} composerBlockDuplicate":function(b,c,d,e){var f=l.getBlockType(d);if("gallery"==f){d.removeAttr("data-uid"),l.setBlockUid(d);var g=l.data(e),h=a.extend(!0,{},g);l.setBlockData(d,h);var i=l.data(d);a.each(i.itemsKeyArray,function(b,c){var e=i.items[c],f=a.uid("g");c==i.primary&&(i.primary=f),delete i.items[c],delete i.itemsArray[c],delete i.itemsKeyArray[b],i.items[f]=e,i.itemsArray[f]=e,i.itemsKeyArray[b]=f,d.find("[data-id="+c+"]").attr("data-id",f)
...
f.append(e),e.removeClassAfter("is-new",1e3),setTimeout(function(){e.remove()},2500)},setImageSource:function(a,c){var d=k.data(a),e=r.getVariation(c.uri,d.variation);d.variation=e.key,d.url=e.url,d.uri=c.uri,d.natural_width=e.width,d.natural_height=e.height,d.natural_ratio=e.width/e.height;var f=b.constructImage(d);k.getBlockContent(a).empty().append(f),b.setImageAlignment(a,d.alignment)},updateImageSource:function(a,c){b.setImageSource(a,c),b.populate(a)},getSourceThumbnailImage:function(b){return a("<img>").attr("src",b)[0]
},populateImageUrl:function(a){var c=k.data(a),d=b.urlFieldset();return d.removeClass("t-hidden"),c.isurl?(b.urlFieldText().val(c.url),void 0):(d.addClass("t-hidden"),void 0)},populateImageSource:function(c){var d=k.data(c),e=b.sourceFieldset();if(e.removeClass("hidden"),d.isurl)return e.addClass("hidden"),void 0;var f=d.uri,e=b.sourceFieldset();e.addClass(g),r.getMedia(f).done(function(d){var e=d.meta;b.sourceThumbnail().css("background-image","url("+e.preview+")"),b.sourceTitle().text(e.title);var f=a(d.variations);
b.variationListContainer().empty().append(f),b.populateImageVariation(c)}).fail(function(){e.addClass(h)}).always(function(){e.removeClass(g)})},populateImageVariation:function(c){var d=k.data(c),e=d.uri,f=d.variation,g=r.getVariation(e,f);if(!g)return console.error(j),void 0;var h=b.variationItem().where("key",'"'+f+'"').activateClass("active");b.sourceSize().text(a.plupload2.formatSize(g.size||"")),b.sourceUrl().text(g.url||"");var i=h.hasClass("is-system"),l=h.hasClass("is-missing");b.variationField().toggleClass("can-delete",!i).toggleClass("is-missing",l)
},setImageVariation:function(c,d){var e=k.data(c),f=e.uri,g=r.getVariation(f,d);if(void 0!==g){e.url=g.url,b.imageElement.inside(c).attr("src",g.url),b.showImageHint(c,a.String.capitalize(g.name)+'<br/><span style="font-weight: normal;">'+g.width+"x"+g.height+"</span>"),e.variation=d;{e.ratio_lock}b.setImageWidth(c,g.width),b.setImageHeight(c,g.height),b.width().val(g.width),b.height().val(g.height)}},updateImageVariation:function(a,c){b.setImageVariation(a,c),b.populateImageVariation(a)},"{variationItem} click":function(a){var c=a.data("key");
b.updateImageVariation(o,c)},"{variationNewButton} click":function(){b.variationField().addClass("show-create-form");var c=k.data(o),d=c.uri,e=r.getVariation(d,"system/original"),f=e.width,g=e.height,h=f/g;b.variationWidth().val(f).data("value",f).data("ratio",h),b.variationHeight().val(g).data("value",g).data("ratio",h)},"{variationCancelButton} click":function(){b.variationField().removeClass("show-create-form")},"{variationCreateButton} click":function(){var d=b.variationField(),e=a.trim(b.variationName().val()),f=b.variationWidth().val(),g=b.variationHeight().val();
if(""!=a.trim(e)){d.addClass("is-creating");var h=o,i=k.data(h),j=i.uri;r.createVariation(j,e,f,g).done(function(c){var e=a(c.variations);b.variationListContainer().empty().append(e),b.populateImageVariation(h),d.removeClass("show-create-form")}).fail(function(){d.removeClass("is-creating").addClass("is-failed")}).always(function(){d.removeClass("is-creating")})}},"{variationCancelFailedButton} click":function(){b.variationField().removeClass("is-failed")},"{variationRebuildButton} click":function(){var d=k.data(o),e=d.uri,f=b.variationItem(".active"),g=f.data("key"),h=r.getVariation(e,g),i=h.name,j=r.getKey(e);
EasyBlog.ajax("site/views/mediamanager/rebuildVariation",{name:i,key:j}).done(function(c){var d=a(c.variations);b.variationListContainer().empty().append(d),b.populateImageVariation(o),r.setMedia(e,c)})},"{variationDeleteButton} click":function(){var d=k.data(o),e=d.uri,f=b.variationItem(".active"),g=f.data("key"),h=r.getVariation(e,g),i=h.name;r.removeVariation(e,i).done(function(c){var d=a(c.variations);b.variationListContainer().empty().append(d);var f=r.getVariation(e,"thumbnail");b.updateImageVariation(o,f.key)
})},"{variationWidth} input":function(c){var d=c.data("ratio"),e=Math.round(parseFloat(c.val()));if(a.isNumeric(e)){var f=Math.round(e/d);b.variationHeight().val(f)}},"{variationHeight} input":function(c){var d=c.data("ratio"),e=Math.round(parseFloat(c.val()));if(a.isNumeric(e)){var f=Math.round(e*d);b.variationWidth().val(f)}},"{variationWidth} focus":function(a){a.select()},"{variationHeight} focus":function(a){a.select()},"{variationWidth} blur":function(c){var d=c.data("ratio"),e=Math.round(parseFloat(c.val()));
if(c.val(e),!a.isNumeric(e)){var f=b.variationHeight(),g=Math.round(parseFloat(f.val()));a.isNumeric(g)?(e=Math.round(g*d),c.val(e),f.val(g)):b.resetVariationFields()}},"{variationHeight} blur":function(c){var d=c.data("ratio"),e=Math.round(parseFloat(c.val()));if(c.val(e),!a.isNumeric(e)){var f=b.variationWidth(),g=Math.round(parseFloat(f.val()));a.isNumeric(g)?(e=Math.round(g/d),f.val(g),c.val(e)):b.resetVariationFields()}},resetVariationFields:function(){var a=b.variationWidth(),c=b.variationHeight();a.val(a.data("width")),c.val(c.data("height"))
},populateImageSize:function(c){var d=function(){var a=k.data(c),d=parseInt(b.getImageWidth(c)),e=parseInt(b.getImageHeight(c));b.width().val(d),b.height().val(e);var f=a.width_lock&&a.height_lock;f?b.fieldsets("[data-type=simple]").addClass("t-hidden"):b.fieldsets("[data-type=simple]").removeClass("t-hidden"),b.lockRatio().prop("checked",a.ratio_lock)},e=b.imageElement.inside(c);if(e[0].complete){d();{k.data(c)}b.imageSizeFieldset().removeClass("is-loading")}else{var g=e.attr("src");b.imageSizeFieldset().addClass("is-loading"),a.Image.get(g).done(function(){var e=k.data(c);
e.natural_ratio=e.width/e.height,d(c)}).always(function(){b.imageSizeFieldset().removeClass("is-loading")})}},setImageSize:function(a,c,d){"width"==c&&b.setImageWidth(a,d),"height"==c&&b.setImageHeight(a,d)},updateImageSize:function(a,c,d){b.setImageSize(a,c,d),b.populateImageSize(a)},isFluidImage:function(a){return b.imageContainer.inside(a).hasClass(f)},isFixedImage:function(a){return!b.isFluidImage(a)},toFixedImage:function(a){var c=k.data(a),d=b.imageElement.inside(a),e=d.width(),f=d.height();b.setImageWidth(a,e);
var g=c.ratio_lock;g||b.setImageHeight(a,f)},toFluidImage:function(a){var c=k.data(a),d=b.imageContainer.inside(a),e=b.imageElement.inside(a);if(k.isRootBlock(a))var f=d.width(),g=a.width(),h=Math.round(f/g*100)+"%";if(k.isNestedBlock(a))var h="100%";var i=e.height();b.setImageWidth(a,h);var j=c.ratio_lock;j||b.setImageHeight(a,i)},normalizeImageSize:function(a){var c=k.data(a),d=b.isFluidImage(a);if(k.isRootBlock(a))var e=b.imageFigure.inside(a).width();if(k.isNestedBlock(a))var e=b.imageFigure.inside(a).width();
b.setImageWidth(a,e),(d||"advanced"==c.mode)&&b.toFluidImage(a)},resetImageSize:function(a){var c=k.data(a);c.mode="simple";b.imageContainer.inside(a),b.imageFigure.inside(a),b.imageElement.inside(a);k.isNestedBlock(a)&&b.setImageWidth(a,a.css("width"))},getImageWidth:function(a){var c=b.imageFigure.inside(a),d=c[0].style;if(k.isRootBlock(a)){var e=b.imageContainer.inside(a),f=e[0].style.width;if(/%/.test(f))return f}if(k.isNestedBlock(a)){var g=a[0].style.width;if(/%/.test(g))return g}return d.width||c.css("width")
},getImageHeight:function(a){var c=b.imageFigure.inside(a),d=c[0].style;return d.height||c.css("height")},setImageWidth:function(a,c){var d=k.getData(a),e=l(c),g=parseFloat(c),h="%"==e,i="px"==e,j="simple"==d.mode,m="advanced"==d.mode,o=b.imageContainer.inside(a),q=b.imageElement.inside(a),t=(b.imageViewport.inside(a),b.imageFigure.inside(a)),x=(q.width(),q.height());h&&(d.fluid=!0,o.addClass(f)),i&&(d.fluid=!1,o.removeClass(f)),m&&b.toFixedElement(a),k.isRootBlock(a)&&(a.css("width",""),h&&(s(o,c),s(t,"100%"),j&&(s(q,"100%"),d.element_width="100%")),i&&(s(o,""),s(t,c),j&&(s(q,c),d.element_width=parseFloat(c)))),k.isNestedBlock(a)&&(h&&(s(a,c),s(t,""),j&&(s(q,"100%"),d.element_width="100%")),i&&(s(a,"auto"),s(t,c),j&&(s(q,c),d.element_width=parseFloat(c)))),d.width=h?c:g;
...
c.placeholder().css("height","400px").appendTo(d),c.element().append(b),c.attach()}a.data("overlay",c)},isUrlValid:function(a){if(""==a)return!1;var b=/^(?:http(?:s)?:\/\/)?www\.instagram\.com\/p\/(.*)(?:\/)?$/,c=b.test(a);return c},"{insert} click":function(a){if(h.length<1){var d=b.block.of(a);f.activateBlock(d)}var e=f.getBlockContent(h),g=b.source.inside(e).val();return b.isUrlValid(g)?(b.fsSource().val(g),b.createIframe(h,g),b.form.inside(e).addClass("hidden"),void 0):(b.errorMessage().removeClass("hide"),void 0)
...
if(0!=e){d.width=e;var g=b.getOverlay(h),i=b.wrapper.inside(h);i.css("width",e);var g=b.getOverlay(h);g.refresh()}},250),"{height} keyup":a.debounce(function(a){var d=f.data(h),e=a.val();if(0!=e){d.height=e;var g=b.wrapper.inside(h);g.css("height",e);var i=b.getOverlay(h);i.refresh()}},250),"{updateUrl} click":function(){var d=b.url().val(),g=(f.data(h),f.getBlockContent(h));return b.isUrlValid(d)?(b.crawl(d,h),void 0):(b.errorMessage.inside(g).removeClass("hide"),void 0)}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/module",function(a){var b=this;
...
},toData:function(a){var b=f.data(a);return b},toText:function(a){var b=f.data(a);return b.embed},toEditableHTML:function(){return""},toHTML:function(a){var b=f.data(a);return b.embed},activate:function(a){h=a,b.populate(a)},deactivate:function(){},construct:function(){},reconstruct:function(c){var d=f.data(c),e=f.getBlockContent(c);d.html&&(e.empty(),b.loadPlaceholder(c,d)),d.html||e.html(a(g.html))},deconstruct:function(a){var c=f.getBlockContent(a);return b.form.inside(c).remove(),a},refocus:function(){},reset:function(){},populate:function(a){var c=f.data(a);
b.updateFieldset(c.id)},showForm:function(a){var c=f.getBlockContent(a);b.placeholderInfo.inside(c).removeClass("hidden"),b.moduleSelectionContent.inside(c).removeClass("hidden")},hideForm:function(a){var c=f.getBlockContent(a);b.placeholderInfo.inside(c).addClass("hidden"),b.placeholderNotice.inside(c).removeClass("hidden")},loadPlaceholder:function(a){var d=f.getBlockContent(a),e=f.data(a);if(b.updateFieldset(e.id),e.html){d.html(e.html);var g=b.placeholderTitle.inside(d),h=b.moduleSelection.inside(d);g.html(e.name),h.data("flag")?h.val(e.module+"-"+e.id):h.val(e.module)
}else{var g=b.placeholderTitle.inside(d);g.html(e.name),e.html=d.html()}},processModule:function(a,c){var e=(f.getBlockContent(a),f.data(a));b.loading(),EasyBlog.ajax("site/views/composer/checkModuleContent",{module:c.module}).done(function(){e.moduleObj=c,e.id=c.id,e.name=c.name,e.module=c.module,b.updateFieldset(e.id),b.loading(),b.hideForm(a),b.loadPlaceholder(a,e),b.removeError(a)}).fail(function(){b.loading(),b.showError(a)})},showError:function(a){var c=f.getBlockContent(a);b.errorMessage.inside(c).removeClass("hidden"),b.placeholderNotice.inside(c).addClass("hidden"),b.placeholderTitle.inside(c).addClass("hidden"),b.placeholderInfo.inside(c).addClass("hidden")
},removeError:function(a){var c=f.getBlockContent(a);b.errorMessage.inside(c).addClass("hidden"),b.placeholderNotice.inside(c).removeClass("hidden"),b.placeholderTitle.inside(c).removeClass("hidden")},updateFieldset:function(a){b.moduleItem().removeClass("active"),b.moduleList().find("[data-id='"+a+"']").addClass("active")},loading:function(){var a=f.getBlockContent(h),c=b.loader.inside(a),d=b.form.inside(a);b.isLoading?(c.addClass("hidden"),d.removeClass("hidden"),b.isLoading=!1):(c.removeClass("hidden"),d.addClass("hidden"),b.isLoading=!0)
},"{moduleItem} click":function(c){var d=a(c).data("id"),e=a(c).data("title"),f=a(c).data("module"),g={id:d,name:e,module:f};b.processModule(h,g)},"{moduleSelection} change":function(c){var e=a(c).val(),f=e.split("-"),g=f[0],i=a(c).find(":selected").data("id"),j=a(c).find(":selected").html(),k={id:i,name:j,module:g};b.processModule(h,k)}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/mtv",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Handlers.Mtv",{elements:["[data-mtv-fieldset-{url|fluid|width-fieldset|height-fieldset|width|height|update-url}]"],defaultOptions:a.extend({"{form}":"> [data-mtv-form]","{insert}":"[data-mtv-insert]","{source}":"[data-mtv-source]","{loader}":"> [data-mtv-loader]","{errorMessage}":"[data-mtv-error]","{player}":"iframe","{wrapper}":"[data-mtv-wrapper]"},EBD.selectors)},function(b,c,d,e,f,g,h){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a()
},toData:function(a){var c=f.data(a),d=a.data("overlay");if(!d)return c;var e=b.player.inside(d.element());return c.source=e.attr("src"),c},toText:function(a){var b=f.data(a);return b.source},toHTML:function(a){var c=(f.data(a),a.data("overlay"));return c?c.element().html():void 0},activate:function(a){f.getBlockContent(a),f.data(a);h=a,b.populate(a)},deactivate:function(){},construct:function(){},getWrapper:function(){var c=a(g.wrapper);return c},getPlayer:function(b){var c=a(g.player);return c.attr("src",b),c
...
},activate:function(a){h=a,b.populate(a)},construct:function(b){{var b=a.extend({},c.data,b);a(g.content).switchClass("alert-"+b.type).html(b.content)}},reconstruct:function(){},deconstruct:function(a){var c=f.getBlockContent(a);return b.note.inside(c).editable(!1),a},refocus:function(a){var c=f.getBlockContent(a),d=b.note.inside(c);d.focus(),a.hasClass("is-new")&&e.editor.caret.setEnd(d[0])},toText:function(a){var c=f.getBlockContent(a),d=b.note.inside(c).text();return d},toData:function(a){var b=f.data(a);
...
}a.data("overlay",d)},createEmbedObject:function(d){b.placeholder.inside(d).remove();var e=a(document.createElement("object")),g=document.createElement("iframe"),i=(f.getBlockContent(d),f.data(d)),j=i.url,k=d.data("overlay");k&&k.element().empty();var l=b.getHeight(d);return e.attr("data",j),e.attr("type","application/pdf"),e.attr("width",c.width),e.attr("height",l),g.setAttribute("width",c.width),g.setAttribute("height",l),g.setAttribute("src",j),g.setAttribute("scrolling","no"),g.setAttribute("frameborder","0"),g.setAttribute("allowTransparency","true"),e.html(g),b.setOverlay(d,e),g
...
},scriptLoaded:!1,loadScript:function(){b.scriptLoaded||(a("<script>").attr("type","text/javascript").attr("src","//assets.pinterest.com/js/pinit.js").appendTo("head"),b.scriptLoaded=!0)},"{insert} click":function(a){if(h.length<1){var c=b.block.of(a);f.activateBlock(c)}var d=f.getBlockContent(h),e=b.source.inside(d).val();b.loadScript(),b.fsSource().val(e),b.insertEmbed(h,e)},"{fsUpdate} click":function(){var c=(f.getBlockContent(h),b.fsSource().val());b.insertEmbed(h,c)}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/post",function(a){var b=this;
...
return c.placeholder().css("height","600px").appendTo(d),c.element().append(b),c.attach(),a.data("overlay",c),void 0}c.element().empty(),c.element().append(b)},isUrlValid:function(a){if(""==a)return!1;var b=/^(http|https):\/\/www\.slideshare\.net\/(.*)$/,c=b.test(a);return c},crawl:function(a,c){var d=f.getBlockContent(a),e=f.data(a);if(!b.isUrlValid(c))return b.errorMessage().removeClass("hide"),!1;var g=a.data("overlay");g&&g.element().empty(),b.loading(),EasyBlog.ajax("site/views/crawler/crawl",{url:c}).done(function(d){var f=d[c];
...
b.tabHeaderListItem.inside(h).eq(g).find("a").html(i),f.data(h).tabs[g].content=i}},250),"{controlItemContent} keypress":function(a,b){var c=b.keyCode?b.keyCode:b.which;"13"==c&&b.preventDefault()}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/ted",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Handlers.Ted",{elements:["[data-ted-fieldset-{url|fluid|width-fieldset|height-fieldset|width|height|update-url}]"],defaultOptions:a.extend({"{form}":"> [data-ted-form]","{insert}":"[data-ted-insert]","{source}":"[data-ted-source]","{loader}":"> [data-ted-loader]","{errorMessage}":"[data-ted-error]","{player}":"iframe","{wrapper}":"[data-ted-wrapper]"},EBD.selectors)},function(b,c,d,e,f,g,h){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a()
},toData:function(a){var c=f.data(a),d=a.data("overlay");if(!d)return c;var e=b.player.inside(d.element());return c.source=e.attr("src"),c},toText:function(a){var b=f.data(a);return b.source},toHTML:function(a){var b=a.clone(),d=(f.data(b),a.data("overlay"));return d?d.element().html():void 0},activate:function(a){f.getBlockContent(a),f.data(a);h=a,b.populate(a)},deactivate:function(){},construct:function(){},getWrapper:function(){var c=a(g.wrapper);return c},reconstruct:function(a){var c=f.data(a),d=a.data("overlay"),e=f.getBlockContent(a);
c.source&&!d?b.setOverlay(a):!c.source&&c.url?(e.html(g.html),b.crawl(c.url,a)):e.html(g.html),a.find(b.source.selector).off("paste").on("paste",function(a){a.stopPropagation()})},deconstruct:function(){},refocus:function(){},reset:function(){},populate:function(a){f.data(a);b.updateFieldset(a)},updateFieldset:function(a){var c=f.data(a);c.url&&(b.url().val(c.url),b.width().val(c.width),b.height().val(c.height),b.fluid().val(c.fluid?"1":"0").trigger("change"))},getOverlay:function(a){var c=a.data("overlay"),g=(f.data(a),f.getBlockContent(a));
if(!c){c=e.document.overlay.create(a);var h=b.getWrapper();c.placeholder().appendTo(h),g.empty().append(h),c.attach()}return c},setWrapperLayout:function(a){var c=b.wrapper.inside(a),d=f.data(a);d.fluid?c.addClass("is-responsive").css({width:"",height:""}):(c.hasClass("is-responsive")&&(d.width=c.width(),d.height=c.outerHeight()),b.width().val(d.width),b.height().val(d.height),c.css({width:d.width,height:d.height}).removeClass("is-responsive"))},setOverlay:function(a){var c=f.data(a),d=b.getOverlay(a);d.element().length>0&&d.element().empty(),b.setWrapperLayout(a),d.element().append(c.embed),d.refresh(),a.data("overlay",d)
},isUrlValid:function(a){if(""==a)return!1;var b=/^(http|https):\/\/www\.ted\.com\/talks\/(.*)$/,c=b.test(a);return c},loading:function(){var a=f.getBlockContent(h),c=b.loader.inside(a),d=b.form.inside(a);b.isLoading?(c.addClass("hidden"),d.removeClass("hidden"),b.isLoading=!1):(c.removeClass("hidden"),d.addClass("hidden"),b.isLoading=!0)},crawl:function(a,c){var d=f.data(c),e=f.getBlockContent(c),g=c.data("overlay");g&&g.element().empty();var a="http://www.ted.com/services/v1/oembed.json?url="+encodeURIComponent(a);
b.loading(),EasyBlog.ajax("site/views/crawler/crawl",{url:a}).done(function(e){var f=e[a];d.url=a,d.title=f.oembed.title,d.author={name:f.oembed.author_name,url:f.oembed.author_url},d.embed=f.oembed.html,d.permalink=f.oembed.url,b.setOverlay(c),b.updateFieldset(c)}).fail(function(a){b.errorMessage().removeClass("hide").html(a)}).always(function(){b.loading(),b.form.inside(e).addClass("hidden")})},"{insert} click":function(a){if(h.length<1){var c=b.block.of(a);f.activateBlock(c)}{var d=f.getBlockContent(h),e=b.source.inside(d).val();
f.data(h)}return b.isUrlValid(e)?(b.crawl(e,h),void 0):(b.errorMessage().removeClass("hide"),void 0)},"{fluid} change":function(a){var d=1==a.val()?!0:!1,e=f.data(h);e.fluid=d,b.setWrapperLayout(h),b.widthFieldset().toggleClass("hide",d),b.heightFieldset().toggleClass("hide",d);var g=b.getOverlay(h);g.refresh()},"{width} keyup":a.debounce(function(a){var d=f.data(h),e=a.val();if(0!=e){d.width=e;var g=b.getOverlay(h),i=b.wrapper.inside(h);i.css("width",e);var g=b.getOverlay(h);g.refresh()}},250),"{height} keyup":a.debounce(function(a){var d=f.data(h),e=a.val();
if(0!=e){d.height=e;var g=b.wrapper.inside(h);g.css("height",e);var i=b.getOverlay(h);i.refresh()}},250),"{updateUrl} click":function(){var d=b.url().val(),g=(f.data(h),f.getBlockContent(h));return b.isUrlValid(d)?(b.crawl(d,h),void 0):(b.errorMessage.inside(g).removeClass("hide"),void 0)}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/text",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Handlers.Text",{defaultOptions:{"{block}":".ebd-block[data-type=text]","{blockWrapper}":"> [data-eb-text-block-wrapper]","{contentWrapper}":"> [data-eb-text-block-wrapper] > [data-eb-text-content-wrapper]","{allContentWrapper}":"[data-eb-text-content-wrapper]","{lastParagraph}":"> p:last"}},function(b,c,d,e,f,g,h){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a()
},activateKeys:function(){a(document).off("keydown.blocks.text")},deactivateKeys:function(){a(document).on("keydown.blocks.text",function(a){var b=a.which;return 33==b||34==b?(a.preventDefault(),!1):!0})},getContent:function(a){var c=f.getBlockContent(a),d=b.contentWrapper.inside(c),e=d.find("p").text();return e},activate:function(c){if(b.deactivateKeys(),h=c,content=b.getContent(c),content=a.trim(content),content==g.data.default){var d=f.getBlockContent(c),e=b.contentWrapper.inside(d);e.find("> p").html("&nbsp;").focus()
}b.populate()},deactivate:function(c){b.activateKeys();var d=b.getContent(c);if(d=a.trim(d),0==d.length||" "==d){var e=f.getBlockContent(c),h=b.contentWrapper.inside(e);h.find("> p").html(g.data.default)}},construct:function(){var b=f.createBlock("text"),c=f.getBlockContent(b);return c.html(g.data.content),b},reconstruct:function(c){var d=f.getBlockContent(c),e=b.blockWrapper.inside(d);e.length||(e=a(g.blockWrapper).append(d[0].childNodes).appendTo(d));var h=b.contentWrapper.inside(d);if(!h.length){var i=[];
a.each(e[0].childNodes,function(){a(this).is(EBD.block)||i.push(this)}),h=a(g.contentWrapper).append(i).appendTo(e)}},"{self} composerBlockDuplicate":function(a,b,c,d){var e=f.getBlockType(c);"text"==e&&(f.updateBlockUid(c),f.duplicateChildBlocksData(c,d))},deconstruct:function(a){var c=f.getBlockContent(a),d=b.contentWrapper.inside(c);if(0==d.length)return a;var e=d[0].childNodes,g=c.find(EBD.immediateNestedBlock).filter(":not(.is-isolated)");return c.empty().append(g).append(e),a},refocus:function(){},reset:function(){},populate:function(){},recover:function(){},revert:function(){},toText:function(a){var c=a.clone(),d=b.deconstruct(c),e=f.getBlockContent(d).text();
...
f.font.populateFontFormatting(b)},100)}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/thumbnails",function(a){var b=this,c="view-selectratio",d="view-customratio",e=["numslider","numslider-toggle","numslider-widget","numslider-value","numslider-input"],f=function(b){if(b=a.trim(b),/\:/.test(b)){var c=b.split(":");return parseInt(c[0])+":"+parseInt(c[1])}return parseFloat(b)||0};EasyBlog.Controller("Composer.Blocks.Handlers.Thumbnails",{elements:["[data-eb-thumbnails-{layout-fieldset|layout-selection|size-fieldset|strategy-field|strategy-menu-item}]","[data-eb-thumbnails-columns-field] [data-eb-{"+e.join("|")+"}]","[data-eb-thumbnails-{ratio-button|ratio-label|ratio-customize-button|ratio-cancel-button|ratio-use-custom-button|ratio-cancel-custom-button|alignment-selection|size-field|ratio-selection|ratio-input}]"],defaultOptions:{"{thumbUploadPlaceholder}":".eb-thumbs-upload-placeholder","{thumbContainer}":".eb-thumbs","{thumbColumn}":".eb-thumbs-col","{thumbItem}":".eb-thumb","{thumbViewport}":"> div","{thumbPlaceholder}":".eb-thumb-placeholder","{thumbImage}":".ebd-block[data-type=image]","{browseButton}":"[data-eb-thumbnails-browse]"}},function(b,e,g,h,i,j,k,l,m){return{init:function(){i=b.blocks,h=i.composer,j=e.meta,k=a(),l=i.dimensions,mediaManager=EasyBlog.MediaManager,mediaUploader=mediaManager.uploader,m=i.getBlockHandler("image"),b.initIndexing(k)
},initIndexing:function(c){var d=b.thumbItem.inside(c);indexing=a(d).length},normalize:function(b){return a.extend({},j.data,b)},activate:function(a){k=a,b.initIndexing(a),b.populate(a)},deactivate:function(a){b.destroySortable(a)},initSortable:function(c){b.thumbColumn.inside(c).each(function(){var c=a(this);c.hasClass("ui-sortable")||c.sortable({items:b.thumbItem.selector,connectWith:b.thumbColumn.selector,tolerance:"pointer",refreshPositions:!0})})},destroySortable:function(c){b.thumbColumn.inside(c).each(function(){var b=a(this);
if(b.hasClass("ui-sortable"))try{b.sortable("destroy")}catch(c){}})},construct:function(){},constructImage:function(a,c){var d=b.addThumbItem(a);d.removeClass("is-uploading"),d.find(".eb-loader-o").remove();var e=b.thumbViewport.inside(d);d.append(e);var f=b.createThumbImage(a,c);e.html(f);var g=b.thumbContainer.inside(a);g.removeClass("is-empty")},reconstruct:function(a){a.editable(!1);var c=b.thumbUploadPlaceholder.inside(a);EasyBlog.MediaManager.uploader.register(c)},deconstruct:function(a){return b.destroySortable(a),b.thumbUploadPlaceholder.inside(a).remove(),a
},refocus:function(){},reset:function(){},toData:function(a){var b=i.data(a);return b},toText:function(){},toHTML:function(a){var c=a.clone(),d=b.deconstruct(c),e=i.getBlockContent(d);return e.html()},createThumbItem:function(){return a(j.thumbItem)},addThumbItem:function(a){var c=b.createThumbItem();c.attr("data-position",indexing),indexing++;var d=b.getNextColumn(a);return d.append(c),c},getNextColumnIndex:function(a){var c=i.data(a),d=b.thumbItem.inside(a).length,e=d,f=c.column_count,g=b.getColumnIndex(e,f);
return g},getColumnIndex:function(a,b){return a-Math.floor(a/b)*b},getNextColumn:function(a){var c=b.getNextColumnIndex(a),d=b.thumbColumn.inside(a).eq(c);return d},createThumbPlaceholder:function(){return a(j.thumbPlaceholder)},createThumbImage:function(b,c){var d=i.data(b),e=c.uri,f=mediaManager.getVariation(e,"small"),g=mediaManager.getVariation(e,"large"),h=f.width,j=f.height,k=h/j,l={uri:e,url:f.url,variation:f.key,mode_lock:!0,width_lock:!0,height_lock:!0,element_ratio:k,natural_width:h,natural_height:j,natural_ratio:k,caption_enabled:!1,link_enabled:!1,style_enabled:!1,size_enabled:!1,popup_uri:e,popup_url:g.url,popup_variation:g.key},m=d.layout;
"stack"==m&&a.extend(l,{mode:"simple",fluid:!1,width:"100%"}),"grid"==m&&a.extend(l,{mode:"advanced",fluid:!0,width:"100%",height:"100%",ratio:d.ratio,strategy:d.strategy});var n=i.constructNestedBlock("image",l).addClass("is-isolated");return n},"{thumbUploadPlaceholder} mediaUploaderFilesAdded":function(c,d,e,f){var g=i.block.of(c);a.each(f,function(a,c){var d=c.id,e=b.addThumbItem(g);e.addClass("is-uploading").attr("data-file-id",d);var f=b.thumbViewport.inside(e),h=b.createThumbPlaceholder();e.append(f),mediaUploader.addItem(c,h);
var i=b.thumbContainer.inside(g);i.removeClass("is-empty")})},"{thumbUploadPlaceholder} mediaUploaderFileUploaded":function(a,c,d,e,f){var g=e.id,h=f.response,j=h.media,k=j.meta;setTimeout(function(){var c=i.block.of(a),d=b.thumbItem().where("fileId",g);d.removeClass("is-uploading").removeAttr("data-file-id").find(".eb-loader-o").remove(),mediaUploader.removeItem(e,d);var f=b.thumbViewport.inside(d),h=b.createThumbImage(c,k);f.html(h)},600)},populate:function(a){var c=b.hasThumbnails(a),d=i.panel.fieldgroup.get("thumbnails");
...
if(0!=e){d.height=e;var g=b.wrapper.inside(h);g.css("height",e);var i=b.getOverlay(h);i.refresh()}},250),"{updateUrl} click":function(){var d=b.url().val(),g=(f.data(h),f.getBlockContent(h));return b.isUrlValid(d)?(b.crawl(d,h),void 0):(b.errorMessage.inside(g).removeClass("hide"),void 0)}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/youtube",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Handlers.Youtube",{elements:["[data-youtube-fieldset-{url|fluid|width-fieldset|height-fieldset|width|height|update-url}]"],defaultOptions:a.extend({"{related}":"[data-youtube-fieldset-related]","{form}":"> [data-youtube-form]","{insert}":"[data-youtube-insert]","{source}":"[data-youtube-source]","{loader}":"> [data-youtube-loader]","{errorMessage}":"[data-youtube-form]","{player}":"iframe","{wrapper}":"[data-youtube-wrapper]"},EBD.selectors)},function(b,c,d,e,f,g,h){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a()
...
c.source&&!d?b.setOverlay(a):0==c.source.length&&c.url?(e.html(g.html),b.crawl(c.url,a)):e.html(g.html),a.find(b.source.selector).off("paste").on("paste",function(a){a.stopPropagation()})},deconstruct:function(){},refocus:function(){},reset:function(){},populate:function(a){f.data(a);b.updateFieldset(a)},updateFieldset:function(a){var c=f.data(a);b.url().val(c.url),b.width().val(c.width),b.height().val(c.height),b.fluid().val(c.fluid?"1":"0").trigger("change"),b.related().val(c.related?"1":"0").trigger("change")
},getOverlay:function(a){var c=a.data("overlay"),g=(f.data(a),f.getBlockContent(a));if(!c){c=e.document.overlay.create(a);var h=b.getWrapper();c.placeholder().appendTo(h),g.empty().append(h),c.attach()}return c},setWrapperLayout:function(a){var c=b.wrapper.inside(a),d=f.data(a);d.fluid?c.addClass("is-responsive").css({width:"",height:""}):(c.hasClass("is-responsive")&&(d.width=c.width(),d.height=c.outerHeight()),b.width().val(d.width),b.height().val(d.height),c.css({width:d.width,height:d.height}).removeClass("is-responsive"))
...
return f.activateBlock(c),void 0}{var d=f.getBlockContent(h),e=b.source.inside(d).val();f.data(h)}return b.isUrlValid(e)?(b.crawl(e,h),void 0):(b.errorMessage().removeClass("hide"),void 0)},"{related} change":function(a){var d=f.data(h),e=1==a.val(),g=h.data("overlay");if(g){var i=b.player.inside(g.element()),j=i.attr("src");e||(j=j.replace("?feature=oembed","?feature=oembed&rel=0"),i.attr("src",j)),e&&(j=j.replace("&rel=0",""),i.attr("src",j)),d.related=e}},"{fluid} change":function(a){var d=1==a.val()?!0:!1,e=f.data(h);
if(e.url){e.fluid=d,b.setWrapperLayout(h),b.widthFieldset().toggleClass("hide",d),b.heightFieldset().toggleClass("hide",d);var g=b.getOverlay(h);g.refresh()}},"{width} keyup":a.debounce(function(a){var d=f.data(h),e=a.val();if(d.url&&0!=e){d.width=e;var g=b.getOverlay(h),i=b.wrapper.inside(h);i.css("width",e);var g=b.getOverlay(h);g.refresh()}},250),"{height} keyup":a.debounce(function(a){var d=f.data(h),e=a.val();if(0!=e){d.height=e;var g=b.wrapper.inside(h);g.css("height",e);var i=b.getOverlay(h);i.refresh()
}},250),"{updateUrl} click":function(){var d=b.url().val(),g=(f.data(h),f.getBlockContent(h));return b.isUrlValid(d)?(b.crawl(d,h),void 0):(b.errorMessage.inside(g).removeClass("hide"),void 0)}}}),b.resolve()}),EasyBlog.module("composer/blocks/mobile",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Mobile",{defaultOptions:a.extend({"{blipp}":"[data-eb-blipp]","{viewport}":".eb-composer-viewport","{actionBar}":"[data-eb-composer-actions]"},EBD.selectors)},function(b,c,d,e,f){return{init:function(){f=b.blocks,e=f.composer
},"{blipp} mousedown":function(c,d){d.stopPropagation(),d.preventDefault();var g;a(document).off("mousemove.blip mouseup.blip").on("mousemove.blip",function(d){var e=a.getPointerPosition(d),f=b.viewport(),h=f.offset(),i=30,j=f.width()-10,k=f.height()-30,l=h.left+30,m=e.x-h.left,n=e.y-h.top;c.css("left",m),c.css("top",n),g=null,e.y<i&&(g="addBlock"),e.y>k&&(g="removeBlock"),e.x<l&&(g="viewBlockTree"),e.x>j&&(g="moveBlock")}).on("mouseup.blip",function(){return a(document).off("mousemove.blip"),b.actionBar().show(),e.blocks.droppable.destroyDropzones(),e.sidebar.deactivate("blocks"),e.sidebar.deactivate("explorer"),"addBlock"==g?(e.sidebar.activate("blocks"),e.blocks.droppable.populateDropzones(),b.trigger("ComposerMobileAddBlock"),void 0):"moveBlock"==g?(e.blocks.droppable.populateDropzones(),f.getAllBlocks().on("click.tapremove",function(b){b.stopPropagation();
...
}}},populateFontColor:function(){if(b.lastUpdatedViaFontColorUI)return b.lastUpdatedViaFontColorUI=!1,void 0;var c=g.selection.getParent(),d=a(c).css("color");b.colorpickerToggle().prop("checked",c.style.color),b.updateFontColorUI(d)},setFontColor:function(a){b.lastUpdatedViaFontColorUI=!0;var c=!0;g.inline.toggleStyle("color: "+a,c),b.updateFontColorUI(a)},updateFontColorUI:function(a){b.updatingFontColorUI=!0,!a&&(a="#000"),b.fontColorCaption().css("backgroundColor",a),b.fontColorPicker().colorpicker("setColor",a),b.updatingFontColorUI=!1
...
},updateAnchorNode:function(c){var d=c.data("anchorNode");if(d){var e=a(c.data("linkUrlField")),f=a(c.data("linkTitleField")),g=b.linkBlankOption.inside(c);d.href=a.trim(e.val()),d.title=f.val(),g.is(":checked")?(d.target="_blank",d.rel="noopener noreferrer"):(d.removeAttribute("target"),d.removeAttribute("rel"))}},removeAnchorNode:function(b){var c=b.data("anchorNode");c&&(g.selection.save(),$anchorNode=a(c),$anchorNode.contents().insertAfter($anchorNode),$anchorNode.remove(),g.selection.restore(),b.removeData("anchorNode"))
},"{fontFormatOption} click":function(a){var c=a.data("format");"clear"!=c&&a.toggleClass("active"),b.toggleFontFormatting(c)},"{fontFamilyOption} click":function(a){var c=a.data("value");b.setFontFamily(c)},"{colorpicker} colorpickerChange":function(a,c,d){b.updatingFontColorUI||(b.colorpickerToggle().prop("checked",!0),b.setFontColor(d))},"{colorpickerToggle} change":function(a){a.checked()||b.removeFontColor()},"{fontSizeToggle} click":function(){var c=b.fontSizeCheckbox();c.is(":checked")?(c.prop("checked",!1),b.removeFontSize()):c.prop("checked",!0)
},"{numsliderWidget} nouislide":function(a,c,d){b.numsliderInput().val(Math.abs(d))},"{numsliderWidget} set":function(a,c,d){b.updatingFontSizeUI||b.setFontSize(Math.abs(d))},"{numsliderInput} input":function(c){if(!b.updatingFontSizeUI){var d=Math.abs(a.trim(c.val()));b.setFontSize(d)}},"{numsliderUnit} click":function(a){var c=a.data("unit");b.setFontSizeUnit(c),b.numsliderUnits().removeClass("open")},"{numsliderUnitToggle} click":function(){b.numsliderUnits().toggleClass("open")},"{linkItem} mouseover":function(b){var d=b.data("anchorNode");
d&&a(d).addClass("is-highlighting")},"{linkItem} mouseout":function(b){var d=b.data("anchorNode");d&&a(d).removeClass("is-highlighting")},linkUrlFieldInputHandler:function(){var d=a(this);b.startEditingSelection();var e=a(d.data("linkItem")),f=a.trim(d.val()),h=e.data("anchorNode");return""===f||h||(a.IE&&g.selection.restore(),h=b.createAnchorNode(e),a.IE&&d.focus().val(d.val())),""==f&&h?(b.removeAnchorNode(e),void 0):(b.updateAnchorNode(e),void 0)},linkTitleFieldInputHandler:function(){var d=a(this);b.startEditingSelection();
var e=a(d).data("linkItem");b.updateAnchorNode(e)},"{linkBlankOptionField} click":function(a){var d=a.find("input");d.is(":checked")?d.prop("checked",!1):d.prop("checked",!0),b.startEditingSelection();var e=b.linkItem.of(a);b.updateAnchorNode(e)},"{linkRemoveButton} click":function(a){b.startEditingSelection();var d=b.linkItem.of(a);b.removeLinkItem(d)}}}),b.resolve()})}),EasyBlog.module("composer/blocks/toolbar",function(a){var b=this,c="is-editing-block",d="is-moving-block",e="is-dropping-block",f="is-inserting-block";
EasyBlog.Controller("Composer.Blocks.Toolbar",{elements:["[data-eb-blocks-{close-button|parent-button|cancel-move-button}]","[data-ebd-block-{toolbar|sort-handle}]"],defaultOptions:a.extend({"{cancelDropButton}":"[data-blocks-cancel-drop-button]","{cancelMoveButton}":"[data-blocks-cancel-move]","{closeBlocks}":"[data-toolbar-blocks-close]","{toolbarWrapper}":"[data-toolbar-blocks-wrapper]","{done}":"[data-blocks-done]","{insert}":"[data-blocks-insert]","{move}":"[data-blocks-move]","{duplicate}":"[data-blocks-duplicate]","{remove}":"[data-blocks-remove]"},EBD.selectors)},function(b,g,h,i,j){return{init:function(){j=b.blocks,i=b.blocks.composer
},dropping:!1,cancelDrop:function(){i.blocks.droppable.selectedMenu=null,i.blocks.droppable.selectedBlock=null,i.blocks.droppable.dropStop(),i.manager().removeClass(e)},"{closeBlocks} click":function(){i.manager().removeClass("is-composer-blocks-open").removeClass(f)},"{self} composerBlockDrop":function(){b.dropping=!1},"{self} composerBlockMenuSelected":function(){b.dropping=!0},"{self} click":function(c,d){var e=a(d.target);if(!(!b.dropping||e.is("[data-toolbar-blocks]")||e.parents("[data-eb-composer-blocks]").length>0)){var f=e.parents("[data-ebd-dropzone]").length>0;
f||b.cancelDrop()}},"{self} composerBlockActivate":function(a,d,e){if(!e.hasClass("is-standalone")){i.manager().addClass(c);var f=j.isNestedBlock(e);blockActions=j.getBlockActions(e),f&&(blockActions.find(b.duplicate().selector).remove(),blockActions.find(b.insert().selector).remove()),e.hasClass("is-isolated")&&blockActions.find(b.move().selector).remove()}},"{self} composerBlockDeactivate":function(){i.manager().removeClass(c).removeClass(f)},"{cancelMoveButton} click":function(){i.manager().removeClass(d),i.blocks.droppable.dropStop();
var c=j.getCurrentBlock();c.removeClass("hide").removeClass("is-sort-item"),b.workarea().removeClass("is-sorting")},"{parentButton} click":function(){var b=j.getCurrentBlock();if(b.length){var c=j.getParentBlock(b);c.length?j.activateBlock(c):j.deactivateBlock()}},"{cancelDropButton} click":function(a,c){c.stopPropagation(),b.cancelDrop()},"{closeButton} click":function(){i.views.hide("blocks")},"{duplicate} click":function(a,c){c.stopPropagation();var d=j.getCurrentBlock(),e=j.getBlockContent(d),f=j.getBlockType(d),g=j.getData(d),h=j.createBlock(f);
j.data(h,g),j.setBlockContent(h,e),d.after(h),j.drop(h),j.release(h),j.out(h),b.trigger("composerBlockDuplicate",[h,d])},"{move} click":function(){var c=i.manager().hasClass(d);if(!c){i.blocks.droppable.populateDropzones(),i.manager().addClass(d);var e=j.getCurrentBlock();e.addClass("is-sort-item"),b.workarea().addClass("is-sorting"),b.trigger("composerBlockMove",[e])}},"{remove} click":function(){var c=j.getCurrentBlock();j.removeBlock(c),i.manager().removeClass("is-editing-block").removeClass("is-inserting-block")
},"{insert} click":function(){i.manager().toggleClass("is-composer-blocks-open").toggleClass("is-inserting-block")}}}),b.resolve()}),EasyBlog.module("composer/blocks/tree",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Tree",{elements:["[data-eb-{block|block-icon|block-title|block-level-count|block-child-count}]","[data-eb-blocks-{tree-field|tree|tree-item|tree-item-template|tree-item-icon|tree-item-title|tree-item-group|tree-toggle-button}]"]},function(b,c,d,e,f,g){return{init:function(){f=b.blocks,e=f.composer,g=b.createTreeItem,b.treeItemTemplate=b.treeItemTemplate().detach().html()
...
var e=3,f=4,g=1,i=0;EasyBlog.require().script("composer/vendors/history","composer/vendors/scrolly","composer/document","composer/blocks","composer/category","composer/tags","composer/revisions","composer/mobile","composer/media","composer/posts","composer/templates","composer/panels","composer/panels/post","composer/panels/authorship","composer/panels/category","composer/panels/seo","composer/panels/autopost","shared/gallery","shared/toggler").library("dialog").done(function(a){EasyBlog.Controller("Composer",{hostname:"composer",pluginExtendsInstance:!0,elements:["[data-eb-composer-{manager|actions|form|ghosts|alerts}]","[data-eb-composer-{views|view|viewport|viewport-content}]","[data-eb-{alert-template}]"],defaultOptions:{templates:{},postUid:null,authorId:null,"{frame}":"[data-composer-frame]","{manager}":"[data-composer-manager]","{alert}":"[data-composer-alert]","{alertMessage}":"[data-composer-alert-message]","{retryButton}":"[data-eb-composer-instance-entry-button]","{toolbarViews}":"[data-toolbar-view]","{form}":"[data-composer-form]","{exit}":"[data-composer-exit]","{publish}":"[data-composer-publish]","{preview}":"[data-composer-preview]","{permalinkPreview}":"[data-permalink-preview]","{saveTemplate}":"[data-composer-save-template]","{deleteTemplate}":"[data-composer-delete-template]","{saveDraft}":"[data-composer-save-draft]","{approvePost}":"[data-composer-approve]","{trashPost}":"[data-composer-trash]","{rejectPost}":"[data-composer-reject]","{submitApproval}":"[data-composer-submit-approval]","{updatePost}":"[data-composer-update]","{autosaveWrapper}":"[data-composer-autosave]","{autosaveMessage}":"[data-composer-autosave-message]","{publishedField}":"[data-composer-field-published]","{previewField}":"[data-composer-field-preview]","{draftWarning}":"[data-draft-warning]","{draftDiscard}":"[data-draft-discard]","{draftContinue}":"[data-draft-continue]","{draftItems}":"[data-eb-composer-revisions-item].is-draft","{jceFullWindowBtn}":"[data-eb-composer-page-body].eb-editor--jce #content_fullscreen"}},function(b,c,d,h,j){return{saveOptions:{autosave:!1,showSaveMessage:!0,updateRevisionStatus:!0,updateAddressBar:!0},init:function(){EasyBlog.debug||a(window).on("beforeunload",function(a){return a.preventDefault(),!1
}),c.templates.alert=b.alertTemplate().detach().html(),h=b.frame(),j=b.manager(),c.authorId=h.data("author-id"),c.permalink=h.data("permalink"),c.exitAlert=h.data("exit-alert"),d.noscroll(),EasyBlog.Composer=b,a.extend(c,h.htmlData("composer")),c.mobile=1==c.mobile,b.installPlugins(["media","templates","blocks","posts","panels","document","artboard","tags","category","revisions"]),c.mobile&&b.installPlugins(["mobile"]),b.keepalive.start(),j.hasClass("show-templates")||b.autosave.start(),a("input, textarea").each(function(){a(this).on("focus",function(){j.addClass("input-focused")
}),a(this).on("blur",function(){j.removeClass("input-focused")})}),b.trigger("composerReady")},isPublished:function(){return b.publishedField().val()==g},isDraft:function(){return b.publishedField().val()==e},"{self} composerDocumentReady":function(){h.removeClass("is-loading")},installPlugins:function(c){a.each(c,function(a,c){b.addPlugin(c)})},settings:{get:function(a){return d.find("input[name='"+a+"']").val()},set:function(a,c){return d.find("input[name='"+a+"']").val(c),b.trigger("composerSettingsChange",[a,c]),c
}},getPreviewNamespace:function(){return"post-preview-"+c.authorId+"-"+b.getPostUid()},getPostId:function(){return h.attr("data-post-id")},getPostUid:function(){return h.attr("data-post-uid")},getRevisionId:function(){return b.getPostUid().split(".")[1]},getDoctype:function(){return h.attr("data-post-doctype")},views:{show:function(a){b.trigger("composerViewShow",[a])},hide:function(a){b.trigger("composerViewHide",[a]);var c=b.toolbarViews("[data-type="+a+"]");c.length&&c.removeClass("open"),b.views.show("document")
}},keepalive:{timer:null,start:function(a){var d=b.keepalive,a=a||c.keepalive.interval;d.stop(),1>a||(d.timer=setTimeout(function(){d.run(a)},a))},run:function(a){EasyBlog.ajax("site/views/composer/keepAlive").always(function(){b.keepalive.start(a)})},stop:function(){clearTimeout(b.keepalive.timer)}},autosave:{timer:null,counter:0,start:function(a){var a=a||c.autosave.interval;b.autosave.stop(),1>a||!a||(b.autosave.timer=setTimeout(function(){b.autosave.run(a)},a))},run:function(a){b.autosave.save(),b.autosave.start(a)
},stop:function(){clearTimeout(b.autosave.timer)},save:function(){if(!(b.saving||a("div.ebd-block[data-ebd-dropzone]").length>0)){var c=blocks.getCurrentBlock(),d=b.publishedField().val();0==b.autosave.counter&&d!=f&&b.publishedField().val(e),b.autosave.counter++,h.addClass("is-autosaving"),b.saving=!0;var g=a.Task();b.trigger("composerSave",[g,b]),c.length>0&&blocks.activateBlock(c),g.process().done(function(){a("[data-composer-field-document]").val(g.data.document);var c=b.form().serializeObject();"legacy"==b.getDoctype()&&(c.content=g.data.content),EasyBlog.ajax("site/controllers/posts/autosave",c).done(function(c,d,e){void 0!=d&&(b.autosaveWrapper().removeClass("t-hidden"),b.autosaveMessage().html(c),History.pushState({state:1},"",e),a("[data-eb-composer-post-uid]").val(d.uid),a("[data-eb-composer-revision-id]").val(d.revision_id))
})}).always(function(){b.saving=!1})}}},saving:!1,getSaveData:function(c){b.form().each(function(){var b=a(this).serializeObject();a.extend(c,b)})},save:function(c){if(!b.saving){b.saving=!0,c=a.extend(b.saveOptions,c),c.target?b.form().attr("target",b.getPreviewNamespace()):b.form().attr("target","_self"),c.preview?b.previewField().val(1):b.previewField().val(0);var d=a.Task();d.data.autosave=c.autosave?c.autosave:0,b.trigger("composerSave",[d,b]),d.process().done(function(){a("[data-composer-field-document]").val(d.data.document),b.form().submit()
}).fail(function(){b.trigger("composerSaveError")}).always(function(){b.saving=!1,c.target&&(c.target=void 0),c.preview&&(c.preview=!1)})}},trash:function(){b.disableLeavePrompt(),EasyBlog.dialog({content:EasyBlog.ajax("site/views/composer/confirmTrash"),bindings:{"{deleteButton} click":function(){EasyBlog.ajax("site/views/composer/delete",{uid:b.getPostUid()}).done(function(){})}}})},setMessage:function(c){a.isArray(c)||(c=[c]);var d=c[0],e="success";/error|danger/.test(d.type)&&(e="danger"),b.alert().removeClass("t-hidden"),b.alert().removeClass("o-alert--success o-alert--danger").addClass("o-alert--"+e),b.alert().find(b.alertMessage).html(d.message)
...
},"{exit} click":function(a){c.exitAlert||b.disableLeavePrompt(),window.location=a.data("url")},"{saveDraft} click":function(a){b.disableLeavePrompt(),a.addClass("is-loading");var d=b.publishedField().val();d!=f&&b.publishedField().val(e),b.save({preview:!1,target:!1,autosave:!1,isapply:!1})},"{savePostButton} click":function(a){var c=b.publishedField().val();c!=f&&b.publishedField().val(e),a.addClass("is-saving is-loading"),b.save({autosave:1,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving is-loading")
})},"{submitApproval} click":function(a){b.disableLeavePrompt(),a.addClass("is-loading"),b.publishedField().val(f),b.save({autosave:0,isapply:0})},"{approvePost} click":function(a){b.publishedField().val(g),a.addClass("is-saving is-loading"),b.disableLeavePrompt(),b.save({autosave:0,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving")})},"{rejectPost} click":function(){b.publishedField().val(e),b.disableLeavePrompt(),b.save({autosave:0,isapply:0}).done(function(){})},"{publish} click":function(a){b.previewField().val(0),b.publishedField().val(g),b.disableLeavePrompt(),a.addClass("is-loading"),b.save({autosave:0,isapply:0})
},"{updatePost} click":function(a){b.publishedField().val()==e&&(b.previewField().val(0),b.publishedField().val(g)),b.disableLeavePrompt(),a.addClass("is-loading"),b.save()},"{unpublishPostButton} click":function(){b.publishedField().val(i),b.save({autosave:0,isapply:0})},"{trashPost} click":function(){b.trash()},"{draftContinue} click":function(){b.disableLeavePrompt()},"{draftDiscard} click":function(){EasyBlog.ajax("site/views/composer/discardDraft",{id:b.getPostId()}).done(function(a){b.setMessage({type:"success",message:a}),j.removeClass("warning-draft"),b.draftItems().remove()
}).fail(function(a){b.setMessage(a)})},"{self} composerSelectTemplate":function(){j.removeClass("show-templates"),setTimeout(function(){b.autosave.start()},6e3)},"{permalinkPreview} click":function(){if(b.isDraft())return b.preview().click(),void 0;if(b.isPublished()){window.open(c.permalink,b.getPreviewNamespace())}else console.log(b.isDraft())},"{jceFullWindowBtn} click":function(){a("[data-eb-composer-page-body].eb-editor--jce").toggleClass("eb-editor--fullscreen")},disableLeavePrompt:function(){a(window).off("beforeunload"),a(window).unbind("beforeunload"),window.onbeforeunload=function(){}
}}}),a("body").addController("EasyBlog.Controller.Composer"),b.resolve()})}),EasyBlog.module("composer/document",function(){var b=this;EasyBlog.require().script("composer/document/toolbar","composer/document/permalink","composer/document/location","composer/document/cover","composer/vendors/expanding").done(function(a){EasyBlog.Controller("Composer.Document",{hostname:"document",pluginExtendsInstance:!0,elements:["[data-eb-composer-document] .eb-composer-{viewport|viewport-content}","[data-eb-composer-{page|page-viewport|page-header|page-body}]","[data-ebd-{workarea|textarea}]","[data-ebd-workarea-{ghosts}]","[data-ebd-workarea-{legacy}]"],defaultOptions:{"{root}":"[data-ebd-workarea] "+EBD.root,"{block}":EBD.block,"{nest}":EBD.nest,"{titleField}":"[data-post-title]",plugins:["toolbar","permalink","location","cover"]}},function(b,c,d,e,f,g){return{init:function(){g=b.composer,b.initPlugins(),b.initTitlebar(),b.isLegacy()?b.initLegacyDocument():b.initEasyBlogDocument()
},initPlugins:function(){a.each(c.plugins,function(a,c){b.addPlugin(c)})},initTitlebar:function(){var a=b.titleField().one("focus",function(){a.expandingTextarea()})},initLegacyDocument:function(){if(window.tinyMCE){var c=function(){if(tinyMCE.activeEditor&&tinyMCE.activeEditor.editorContainer){var d=tinyMCE.activeEditor.editorContainer;a.isString(d)||(d.style.width="100%",a(tinyMCE.activeEditor.contentDocument).find("html").css({height:"100%"}).end().find("body").css({height:"100%",margin:"1em"})),b.setLayout()
...
d=a.sanitizeHTML(d),a.IE<9&&(d=a.toXHTML(d)),c.intro="",c.content=d},saveEasyBlogDocument:function(b){var c=f.getRootBlocks(),d=[],e=[],h=b.add("Saving document"),i={title:b.data.title,permalink:b.data.permalink,type:g.getDoctype(),version:"1.0"};a.when.apply(null,e).always(function(){c.each(function(){var b=a(this),c=f.exportBlock(b);d.push(c)}),i.blocks=d,b.data.document=JSON.stringify(i)}).done(function(){h.resolve()}).fail(function(){h.reject(a.Exception("Error saving document."))})},"{self} composerSave":function(a,c,d){if("legacy"==g.getDoctype())return b.saveLegacyDocument(d),void 0;
var e=f.getCurrentBlock();e.length>0&&f.deactivateBlock(e),b.saveEasyBlogDocument(d)},"{titleField} keydown":function(a,b){return 13==b.keyCode?(b.preventDefault(),!1):void 0},"{titleField} keyup":function(a){b.trigger("composerTitleEditing",[a,a.val()])},"{titleField} change":function(a){b.trigger("composerTitleChanged",[a,a.val()])},"{viewport} click":function(c,d){if(!b.isLegacy()){var e=b.workarea();if(!e.hasClass("is-resizing")){var f=a(d.target).parentsUntil(c).andSelf().filter(EBD.block);f.length||b.trigger("composerDocumentBlur")
}}},"{self} composerValidate":function(){},"{self} keyup":function(c,d){if(66==d.keyCode){if(b.isLegacy())return;if(EasyBlog.MediaManager.isOpen())return;var e=a(":input").is(":focus"),f=g.manager().hasClass("is-editing-block"),h=b.titleField().is(":focus");if(f||e||h)return;g.manager().toggleClass("is-composer-blocks-open")}}}}),b.resolve()})}),EasyBlog.module("composer/document/cover",function(){var b=this;EasyBlog.require().library("image","plupload2").done(function(a){EasyBlog.Controller("Composer.Document.Cover",{elements:["[data-eb-composer-blogimage-{browse-button}]",".eb-composer-{field}-blogimage"],defaultOptions:{"{container}":"[data-cover-container]","{placeholder}":"[data-cover-placeholder]","{workarea}":"[data-cover-workarea]","{preview}":"[data-cover-preview]","{browse}":"[data-cover-browse]","{upload}":"[data-cover-upload]","{remove}":"[data-cover-remove]","{progress}":"[data-eb-mm-upload-progress]","{addCoverButton}":".eb-document-add-cover-button","{title}":"[data-cover-title]","{data}":"[data-cover-value]"}},function(b){return{defaultUri:null,init:function(){var a=b.placeholder();
a.length>0&&EasyBlog.MediaManager.uploader.register(a);var c=b.data().val();b.defaultUri=c},setImage:function(c,d,e){b.preview().css("backgroundImage",a.cssUrl(c)),b.data().val(d),e&&b.title().val(e),setTimeout(function(){b.placeholder().addClass("has-image has-art state-done")},250)},"{container} click":function(a,b){b.stopPropagation()},"{browse} mediaSelect":function(a,c,d){b.setImage(d.meta.url,d.meta.uri,d.meta.title),setTimeout(function(){b.container().parent().addClass("open")},5)},"{placeholder} mediaUploaderFilesAdded":function(a,b,c,d){EasyBlog.MediaManager.uploader.addItem(d[0],a)
},"{placeholder} mediaUploaderFileUploaded":function(a,c,d,e,f){var g=f.response,h=g.media,i=h.meta;b.setImage(i.url,i.uri,i.title)},"{placeholder} mediaUploaderFileError":function(){},"{placeholder} mediaUploaderError":function(){},"{workarea} mouseover":function(){b.placeholder().hasClass("has-image")&&b.remove().removeClass("hide")},"{workarea} mouseleave":function(){b.remove().addClass("hide")},"{remove} click":function(){b.placeholder().removeClass("has-image is-uploading has-art"),b.title().val(""),b.data().val("")
}}}),b.resolve()})}),EasyBlog.module("composer/document/location",function(a){var b=this;EasyBlog.Controller("Composer.Document.Location",{elements:["[data-eb-composer-location-{places|autocomplete|form|form-message}]"],defaultOptions:{"{container}":"[data-location-container]",geomode:"native",searchmode:"detect","{detect}":"[data-location-detect]","{remove}":"[data-location-remove]","{preview}":"[data-location-preview]","{map}":"[data-location-map]","{inputContainer}":"[data-location-input-container]","{input}":"[data-location-input]","{address}":"[data-location-address]","{latitude}":"[data-location-latitude]","{longitude}":"[data-location-longitude]","{place}":"[data-eb-composer-location-places] li"}},function(b,c,d,e,f,g){return{init:function(){b.composer=g=b.document.composer,d=b.container(),c.apikey=b.container().data("google-apikey"),navigator.geolocation||(c.geomode="external"),b.setupAutocomplete()
},setupAutocomplete:function(){e=b.autocomplete().detach(),f=e.find(b.places),textfield=b.input(),a(document).on("click",function(b){var c=a(b.target).parents().andSelf();c.filter(textfield).length<1&&e.detach()})},searching:function(a){b.container().toggleClass("is-searching",a);var c=b.input();c.attr("placeholder",a?c.data("placeholder-searching"):c.data("placeholder"))},userCoords:null,getUserCoords:function(){var d=a.Deferred(),e=b.userCoords;return e?(d.resolve(e),d):("native"==c.geomode?navigator.geolocation.getCurrentPosition(function(a){var b=a.coords;
...
g&&i?b.breadcrumbs().html(a.breadcrumb):b.breadcrumbs().append(a.breadcrumb)}h.resolve()}),h}},getSelectionTemplate:function(b){var c=a(f.selection);return c.attr("data-uri",b.uri),c.attr("data-key",b.meta.key),"image"==b.meta.type?c.find("[data-selection-cover]").css("background-image","url("+b.meta.preview+")"):c.find("[data-selection-cover]").html('<i class="'+b.meta.icon+'"></i>'),c[0]},getUploadTemplate:function(b){var d=a(c.templates.upload);return d.attr("data-id",b.id),d.find("[data-eb-mm-upload-type]").addClass("type-"+b.type),d[0]
},folder:{nodes:{},get:function(a){var a=b.getKey(a),c=b.folder.selector+"[data-key='"+a+"']",e=d.find(c);return e},remove:function(a){b.folder.get(a).remove();var c=b.folder().length;0==c&&b.body().removeClass("has-folders")},insert:function(a,c){var d=b.mediaLoaders[a.uri];d||b.setMedia(a.uri,a);var e=b.group("[data-type=folder]"),f=b.groupList.inside(e);b.body().removeClass("is-empty"),b.body().addClass("has-folders"),f.prepend(c)},rename:function(c,d){b.getMedia(c).done(function(c){var e=c.meta;if(e.title!=d){var f=b.folder.get(e.key);
EasyBlog.ajax("site/views/mediamanager/rename",{key:e.key,filename:d}).done(function(c){delete b.mediaLoaders[e.uri],b.setMedia(c.uri,c);var d=a(c.file);f.replaceWith(d),d.addClass("is-selected"),b.panel().data("uri",c.uri);var g=b.getKey(c.uri);b.selection.remove(e.key),b.selection.insert(g,c)})}})}},"{formInput} change":function(c){var e=c.parents(b.panel.selector),f=e.data("uri"),g={key:b.getKey(f)},h=b.formInput.inside(e);h.length>0&&a.each(h,function(c,d){var d=a(d),e=d.attr("name"),f=d.val();d.is("[data-mm-panel-title]")&&b.item("[data-key="+g.key+"]").trigger("mediaTitleChanged",[f]),g["params["+e+"]"]=f
}),EasyBlog.ajax("site/views/mediamanager/updateItemMeta",g).done(function(a){b.panelState().removeClass("t-hidden");var c=a.uri;b.setMedia(c,a)})},"{folderTitle} change":function(c){var e=a.trim(c.val());if(0!=e.length){var f=c.parents(b.panel.selector).data("uri");b.folder.rename(f,e)}},"{folder} click":function(a){var e=a.data("uri"),f=a.data("key"),g=!a.hasClass("is-selected");return c.mobile?(a.dblclick(),void 0):(b.selection.clear(),b.folder().removeClass("is-selected"),a.toggleClass("is-selected",g),g&&b.getMedia(e).done(function(a){b.selection.insert(f,a),b.panel.show(e)
...
return d.find(c)},getSelector:function(a){return b.item.selector+"[data-key='"+a+"']"},activate:function(a){b.file.deactivate(),b.file.active=a.addClass("active")},deactivate:function(){b.file.active.removeClass("active")},insert:function(a){b.body().removeClass("is-empty"),b.body().addClass("has-files");var c=b.getFileGroup("file");b.groupList.inside(c).prepend(a)},remove:function(a){var c=b.file.get(a);c.remove();var d=b.item().length;0==d&&b.body().removeClass("has-files")}},"{showAllFilesButton} click":function(a){b.folder.of(a).removeClass("filter-new")
},panel:{save:function(){var a=b.panel().data("uri");a.length<=0||b.getMedia(a).done(function(a){var c=b.panel().find(">div");a.panel=c.detach()})},populate:function(){},show:function(a){b.panelState().addClass("t-hidden"),b.panel.save(),b.panel().data("uri",a),b.getMedia(a).done(function(a){b.panel().html(a.panel),b.panel().removeClass("t-hidden"),b.frame().addClass("is-info-panel-open")})},hide:function(){b.panel().data("uri",""),b.panel().addClass("t-hidden")}},"{flickrButton} click":function(a){var c=a.data("url"),d=960,e=650,f=screen.width/2-d/2,g=screen.height/2-e/2;
window.doneLogin=function(){b.currentUri="flickrlogin",b.navigate("flickr")},window.open(c,"","scrollbars=no,resizable=no, width="+d+",height="+e+",left="+f+",top="+g)},"{createFolder} click":function(){var e=b.getKey(b.currentUri);EasyBlog.dialog({content:EasyBlog.ajax("site/views/mediamanager/createFolderDialog"),bindings:{"{submitButton} click":function(){var c=this.folderName().val(),d=this.folderName(),f=this.alert();return d.parent().removeClass("has-error"),""==a.trim(c)?(d.parent().addClass("has-error"),void 0):(EasyBlog.ajax("site/views/mediamanager/createFolder",{key:e,folder:c}).done(function(a,c){b.folder.insert(a,c),EasyBlog.dialog().close()
}).fail(function(a){d.parent().addClass("has-error"),f.html(a.message).removeClass("t-hidden")}),void 0)}}})},"{clearSelections} click":function(a,c){c.stopPropagation(),b.selection.clear()},"{delete} click":function(){if(b.selection.hasItems()){var e=b.selection.getItems();EasyBlog.dialog({content:EasyBlog.ajax("site/views/mediamanager/confirmDelete"),bindings:{"{submitButton} click":function(){var c=b.selection.getKeys();EasyBlog.ajax("site/views/mediamanager/delete",{keys:c}).done(function(){a.each(e,function(a,c){var d=b.getUri(a),e="folder"==c.meta.type;
b.removeMedia(d,e)}),b.selection.clear(),EasyBlog.dialog().close()}).fail(function(){console.log("failed",arguments)})}}})}},"{self} mediaRemove":function(a,c,d,e){var f=b.getKey(d);e&&b.folder.remove(f),e||b.file.remove(f);var g=b.item().length,h=b.folder().length;0==g&&0==h&&b.body().addClass("is-empty")},refreshMedia:function(a){a=b.getUri(a),delete b.medias[a],delete b.mediaLoaders[a]},removeMedia:function(a,c){b.getKey(a);b.selection.clear(),b.refreshMedia(a),b.trigger("mediaRemove",[a,c])},"{fileRenameButton} click":function(c){var d=b.info.of(c),e=d.data("key"),f=a.trim(b.infoFilename.inside(d).text());
EasyBlog.dialog({content:EasyBlog.ajax("site/views/mediamanager/renameFileDialog",{current:f}),bindings:{"{submitButton} click":function(){var c=this.fileName().val();""!=a.trim(c)&&b.file.rename(e,c)}}})},"{paginationPrevious} click, {paginationNext} click":function(a){var c=a.data("page"),d=b.getHint("loading");EasyBlog.ajax("site/views/mediamanager/users",{page:c}).done(function(a){d.replaceWith(a)}),b.display(d)},dropzone:{show:function(){b.selection.clear(),b.frame().find("[data-dragzone]").removeClass("t-hidden")
},hide:function(){b.frame().find("[data-dragzone]").addClass("t-hidden")}},dropActivated:!1,"{dropzoneWrapper} dragover":function(){b.canUpload()&&(b.dropActivated||(b.dropActivated=!0,b.dropzone.show(),setTimeout(function(){b.dropzoneWrapper().on("dragleave",function(){b.dropzone.hide(),b.dropActivated=!1,b.dropzoneWrapper().off("dragleave")})},100)))},"{dropzoneWrapper} drop":function(){b.dropzone.hide()},"{selectionItem} click":function(a){var d=a.data("uri");b.panel.show(d)},simulateMetakey:!1,"{checkbox} click":function(a,c){c.preventDefault(),c.stopPropagation();
var d=a.siblings(b.checkboxInput),e=a.parent(b.item);b.simulateMetakey=!0,d.prop("checked",!d.is(":checked")).trigger("change"),e.click()},"{checkboxInput} change":function(){var d=b.checkboxInput(":checked").length;0==d&&(b.simulateMetakey=!1)},"{item} click":function(a,d){var e=!a.hasClass("is-selected"),f=a.data("uri");b.folder().removeClass("is-selected"),b.simulateMetakey=!0,(!b.simulateMetakey&&!d.metaKey||"select"==b.mode&&"thumbnails"!=b.currentBrowseType&&"gallery"!=b.currentBrowseType)&&b.selection.clear(),a.toggleClass("is-selected",e),a.find(b.checkboxInput).prop("checked",e).trigger("change"),b.getMedia(f).done(function(a){var d=b.getKey(a.uri);
if(e)b.selection.insert(d,a),c.mobile||b.panel.show(f);else{b.selection.remove(d);var g=b.selection.hasItems();if(g&&!c.mobile){var h=b.selection.getLastItem();b.panel.hide(),b.panel.show(h.uri)}else b.panel.hide()}})},"{mobileClosePlaces} click":function(){b.frame().removeClass("is-places-open")},"{mobileOpenPlaces} click":function(){b.frame().addClass("is-places-open")},"{mobileOpenPanel} click":function(a,c){c.stopPropagation();var d=a.data("uri");b.frame().addClass("is-info-panel-open"),b.panel.hide(),b.panel.show(d)
},"{mobileHidePanel} click":function(a,c){c.stopPropagation(),b.panel.hide(),b.frame().removeClass("is-info-panel-open")},"{insertGallery} click":function(){var d=b.selection.getItems();b.trigger("mediaInsertGallery",[d]),b.hide()},"{insertPermalink} click":function(){var d=b.selection.getItems();b.trigger("mediaInsertPermalink",[d]),b.hide()},"{insert} click":function(){var e=b.selection.total()>1,f=b.selection.getItems();a.each(f,function(c){var f=b.getUri(c);b.getMedia(f).done(function(c){var d=a("<div>");
d.html(c.info);var g=d.find(EBD.standaloneBlock);b.pauseVideoObject();var h=b.panel().data("uri");if(h==f&&(c.panel=b.panel().find("> div")),c.data=a(c.panel).find("[data-mm-form]").serializeObject(),a.map(c.data,function(a,b){0==a&&(c.data[b]=!1),1==a&&(c.data[b]=!0)}),"image"==c.meta.type&&"lightbox"==c.data.link){var i=b.getVariation(c.data.uri,"original");c.data.popup_url=i.url,c.data.popup_uri=i.uri}"select"==b.mode?b.currentBrowseButton.trigger("mediaSelect",[c,c.data]):b.trigger("mediaInsert",[c,g,c.data,e])
})}),b.hide()},"{layout} click":function(a){var d=a.data("type");b.layout().removeClass("is-active"),b.layout("[data-type="+d+"]").addClass("is-active"),b.listing().removeClass("is-grid is-list").addClass("is-"+d)},"{close} click":function(){b.hide()},"{breadcrumb} click":function(a){var d=a.data("uri"),e=a.nextAll();e.remove(),b.navigate(d,!1)},"{item} mediaTitleChanged":function(a,b,c){var d=a.find("[data-item-title]");d.html(c)},"{self} keyup":function(a,c){27==c.keyCode&&b.isOpen()&&b.hide()},"{self} mediaUploaderFileFiltered":function(a,c,d,e){if(b.canUpload()){{var f=b.uploadItems[e.id]||b.createUploadItem(e);
b.getType(e.name)}b.file.insert(f)}},"{self} mediaUploaderFileError":function(c,d,e,f){var g=f.file,h=a(b.uploadItems[g.id]),i=JSON.parse(f.response);h.addClass("is-failed");var j=h.find("[data-eb-mm-failed-message]");j.attr("data-original-title",i.message),j.attr("data-eb-provide","tooltip")},"{self} mediaUploaderFileUploaded":function(c,d,e,f,g){var h=g.response,i=h.media,j=b.getMedia(i.uri);b.setMedia(i.uri,j),setTimeout(function(){var c=b.uploadItems[f.id];if(c){var d=a(i.file).addClass("is-new");a(c).replaceWith(d)
}},600)},"{self} mediaSelectionUpdated":function(a,c,d,f){var g=b.selection.total();if(b.selectionCounter().html(g),0>=g)return b.actions().removeClass("show-insert show-gallery show-permalink"),void 0;var h=e.document.isLegacy(),i=b.selection.getLastItem(),j=i.meta,k=f.meta;if("folder"!=k.type||h){if("folder"==k.type&&h)return b.actions().addClass("show-gallery"),void 0;g>=1&&b.actions().addClass("show-insert"),g>1&&b.selection.canCreateGallery()?b.actions().addClass("show-gallery"):b.actions().removeClass("show-gallery"),h&&"pdf"==k.type&&k.id==j.id&&"pdf"==j.type?b.actions().addClass("show-permalink"):h&&"pdf"==j.type?b.actions().addClass("show-permalink"):b.actions().removeClass("show-permalink")
}},"{browseButton} click":function(a){var d=a.data("eb-mm-filter"),e=a.data("eb-mm-start-uri"),f=b.getUri(e),g=a.data("eb-mm-browse-place"),h=a.data("eb-mm-browse-type");"post"==f&&(f=b.getCurrentPostUri()),b.mode="select",b.currentBrowseType=h,b.currentBrowseButton=a,b.currentBrowseButton.trigger("mediaSelectStart",[b.currentBrowseButton]),b.open(f,d),"local"==g?b.frame().addClass("show-local"):b.frame().removeClass("show-local")}}});a("body").addController(c),b.resolve(c)})}),EasyBlog.module("composer/media/uploader",function(){var b=this;
...
})}},"{toggleButton} click":function(){g[b.suggestions().hasClass("is-showing")?"collapse":"expand"]()},"{autofillButton} click":function(c){var d=b.composer.document.getText(),e=a(c).parent();a(e).addClass("is-loading"),EasyBlog.ajax("site/views/composer/suggestKeywords",{data:d}).done(function(b){a(e).removeClass("is-loading"),b&&a.each(b,function(a,b){i.addItem(b.title)})})},suggestions:{index:0,tags:[],expand:function(){g.tick++,b.suggestions().addClass("is-showing")},collapse:function(){g.tick++,b.suggestions().removeClass("is-showing")
},refresh:function(){var a=b.item(":not(.is-used)");b.suggestions().toggleClass("is-empty",a.length<1),g.count()},show:function(){g.tick++,g.refresh(),g.expand()},hide:function(){var a=++g.tick;g.collapse(),setTimeout(function(){a===g.tick&&g.reset()},500)},set:function(a){a.length<1?(g.hide(),g.tags=[]):(g.reset(),g.tags=a)},reset:function(){g.tags=[],g.i=0,b.itemgroup().empty()},pid:0,tick:0,currentQuery:null,query:a.memoize(function(a){return EasyBlog.ajax("site/views/tags/suggest",{search:a}).fail(function(){g.query.reset(a)
...
}},"{self} composerSave":function(c,d,e){if("0"!=EasyBlog.Composer.options.tags.enabled){var f=b.tagger.getAddedItems();e.data.tags=a.pluck(f,"title").join(","),b.tagsInput().val(e.data.tags)}}}}),b.resolve()})}),EasyBlog.module("composer/templates",function(){var b=this;EasyBlog.Controller("Composer.Templates",{defaultOptions:{"{updateTemplate}":"[data-eb-composer-update-template-button]","{templateId}":"[data-eb-composer-template-id]","{saveNewTemplate}":"[data-eb-composer-save-template-button]","{selectTemplate}":"[data-template-item]","{templateBlocks}":"[data-template-blocks]","{deleteTemplate}":"[data-template-delete]","{posts}":"[data-eb-composer-posts]","{searchTextfield}":"[data-eb-composer-posts-search-textfield]","{itemGroup}":"[data-eb-composer-posts-item-group]","{list}":"[data-eb-composer-templates-list]"}},function(a,b,c,d){return{init:function(){d=a.composer
},"{selectTemplate} click":function(b){var c=b.data("uid"),e=b.data("blank");return e?(a.trigger("composerSelectTemplate",[c]),void 0):(EasyBlog.ajax("site/views/composer/renderTemplate",{uid:c}).done(function(b,e,f){f&&(d.document.isLegacy()?d.document.insertContent(f):d.document.loadDocument(f)),a.trigger("composerSelectTemplate",[c,b,e,f])}),void 0)},"{deleteTemplate} click":function(b,c){c.stopPropagation();var d=b.parents(a.selectTemplate.selector),e=d.data("uid");EasyBlog.dialog({content:EasyBlog.ajax("site/views/templates/confirmDelete",{id:e,deleteAction:"ajax"}),bindings:{"{submitButton} click":function(){EasyBlog.ajax("site/controllers/templates/delete",{ids:[e]}).done(function(){EasyBlog.dialog().close(),d.remove()
})}}})}}}),b.resolve()}),EasyBlog.module("composer/vendors/colorpicker",function(a){var b=".colorpicker-hsb-panel",c=".colorpicker-h-panel",d=".colorpicker-sb-panel",e=".colorpicker-h-handle",f=".colorpicker-sb-handle",g=".colorpicker-preview",h=".colorpicker-hex-input",i={color:"#000000",document:document};a.fn.colorpicker=function(b){var c=this.data("colorpicker");if(c||(c=new j(this,b)),a.isString(b)){var d=b;return c[d].apply(c,a.makeArray(arguments).slice(1))}return this};var j=function(b,c){this.options=a.extend({},i,c),this.element=b,this.init(),b.data("colorpicker",this)
};a.extend(j.prototype,{init:function(){this.initHPanel(),this.initSBPanel(),this.initHexInput(),this.silent=!0,this.setHex(this.options.color),this.silent=!1},initHPanel:function(){var b=this;b.generateHueColors(),b.element.on(a.ns("mousedown",".colorpicker.h"),c,function(c){c.preventDefault();var d=b.hsbPanel(),e=b.hPanel(),f=b.hHandle(),g=e.offset(),h=g.top,i=e.height(),j=function(c){var d=a.getPointerPosition(c),e=d.y-h,g=e/i;0>g&&(g=0),g>1&&(g=1),f.css({top:100*g+"%"});var j=b.getHsb();b.setHsb(j)};d.addClass("adjusting-h"),j(c);
var k=a(b.options.document);k.on(a.ns("mousemove touchmove",".colorpicker.h"),function(a){a.preventDefault(),j(a)}).on(a.ns("mouseup touchend",".colorpicker.h"),function(b){b.preventDefault(),d.removeClass("adjusting-h"),k.off(a.ns("mousemove mouseup touchend",".colorpicker.h"))})})},destroyHPanel:function(){this.element.off(a.ns("mousedown",".colorpicker.h"))},generateHueColors:function(){var b=this.hPanel(),c=["#ff0000","#ff0080","#ff00ff","#8000ff","#0000ff","#0080ff","#00ffff","#00ff80","#00ff00","#80ff00","#ffff00","#ff8000","#ff0000"];
if(a.IE<=9){var d,e;for(d=0;11>=d;d++)e=a('<div class="colorpicker-hue-stop"></div>').attr("style","height:8.333333%; filter:progid:DXImageTransform.Microsoft.gradient(GradientType=0,startColorstr="+c[d]+", endColorstr="+c[d+1]+'); -ms-filter: "progid:DXImageTransform.Microsoft.gradient(GradientType=0,startColorstr='+c[d]+", endColorstr="+c[d+1]+')";'),b.append(e)}else stopList=c.join(","),b.attr("style","background:-webkit-linear-gradient(top,"+stopList+"); background: -o-linear-gradient(top,"+stopList+"); background: -ms-linear-gradient(top,"+stopList+"); background:-moz-linear-gradient(top,"+stopList+"); -webkit-linear-gradient(top,"+stopList+"); background:linear-gradient(to bottom,"+stopList+"); ")
},initSBPanel:function(){var b=this;b.element.on(a.ns("mousedown",".colorpicker.sb"),d,function(c){var d=b.hsbPanel(),e=b.sbPanel(),f=b.sbHandle(),g=e.offset(),h=g.left,i=g.top,j=e.width(),k=e.height(),l=function(c){var d=a.getPointerPosition(c),e=d.x-h,g=d.y-i,l=e/j,m=g/k;0>l&&(l=0),l>1&&(l=1),0>m&&(m=0),m>1&&(m=1),f.css({top:100*m+"%",left:100*l+"%"});var n=b.getHsb();b.setHsb(n)};d.addClass("adjusting-sb"),l(c);var m=a(b.options.document);m.on(a.ns("mousemove touchmove",".colorpicker.sb"),function(a){a.preventDefault(),l(a)
}).on(a.ns("mouseup touchend",".colorpicker.sb"),function(){c.preventDefault(),d.removeClass("adjusting-sb"),m.off(a.ns("mousemove mouseup touchend",".colorpicker.sb"))})})},destroySBPanel:function(){this.element.off(a.ns("mousedown",".colorpicker.sb"))},initHexInput:function(){var b=this;b.element.on("input",h,function(){var d=a.fixHex(a.trim(b.hexInput().val().replace(/\#/g,"")));b.setHex(d)}).on("focusin",h,function(){b.hexInput().addClass("is-focused")}).on("focusout",h,function(){var c=b.hexInput(),d=c.data("value");
c.removeClass("is-focused").val(d)})},setHsb:function(b){var c=this.hsbPanel();c.hasClass("adjusting-h")||c.hasClass("adjusting-sb")||this.hHandle().css({top:100*(1-b.h/360)+"%"}),c.hasClass("adjusting-sb")||this.sbPanel().css({background:"#"+a.hsbToHex({h:b.h,s:100,b:100})}),this.sbHandle().css({left:b.s+"%",top:100-b.b+"%"});var d="#"+a.hsbToHex(b),e=this.hexInput();e.data("value",d),!e.hasClass("is-focused")&&e.val(d),this.colorPreview().css("background",d),!this.silent&&this.element.trigger("colorpickerChange",d,b)
},getHsb:function(){var b=this.hHandle();sbHandle=this.sbHandle();var c={h:360*(1-parseFloat(b[0].style.top)/100),s:parseFloat(sbHandle[0].style.left),b:100-parseFloat(sbHandle[0].style.top)};return a.fixHsb(c)},setHex:function(b){var b=b.replace(/\#/g,"");this.setHsb(a.hexToHsb(b))},getHex:function(){return"#"+a.hsbToHex(this.getHsb())},setRgb:function(b){if(a.isString(b)){var c=b.match(/\d+/g);b={r:c[0]||0,g:c[1]||0,b:c[2]||0}}this.setHsb(a.rgbToHsb(b))},getRgb:function(){return a.hsbToRgb(this.getHsb())},setColor:function(a){a.match(/^rgb/i)&&this.setRgb(a),a.match(/^\#/)&&this.setHex(a)
},hsbPanel:function(){return this.element.find(b)},hPanel:function(){return this.element.find(c)},sbPanel:function(){return this.element.find(d)},hHandle:function(){return this.element.find(e)},sbHandle:function(){return this.element.find(f)},colorPreview:function(){return this.element.find(g)},hexInput:function(){return this.element.find(h)},widget:function(){return this}}),this.resolve()}),EasyBlog.module("composer/vendors/expanding",function(a){function g(){var b=a(this).data("textareaClone");b.find("div").text(this.value.replace(/\r\n/g,"\n")+" "),a(this).trigger("resize.expanding")
