...
?>
  ...
  <form enctype="multipart/form-data" id="simplecallback-<?php echo $module->id; ?>" action="<?php echo JURI::root(); ?>index.php?option=com_ajax&module=simplecallback&format=json" class="uk-child-width-expand@s uk-grid form-inline uk-text-center simplecallback<?php echo $moduleclass_sfx ?> <?php if ($overlayed == 1) { echo " simplecallback-overlayed
...
<div class="zakonrf">
  ...
  <? endif; ?>
     ...
     <div class="row"> <div class="col-sm"> <?php  echo JCaptcha::getInstance( 'recaptcha' )->display( 'captcha', 'captcha', 'captcha' ); ?>   </div>   </div> 
      <?php endif; ?>
                    <div class="form-group uk-width-auto@s">
