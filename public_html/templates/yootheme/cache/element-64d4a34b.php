<?php // @file /home/s/surovov/vid.uz/public_html/templates/yootheme/vendor/yootheme/builder/elements/slideshow/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['title_style', 'title_decoration', 'title_color', 'title_element', 'title_margin', '_title_parallax']
            ], [
              'label' => 'Meta', 
              'type' => 'group', 
              'divider' => true, 
    ...
    'builder-slideshow-overlay-parallax' => [
      ...
      'fields' => [
        ...
        'overlay_parallax_scale_start' => [
          ...
          'type' => 'range', 
          'attrs' => [
            'min' => 0.299999999999999988897769753748434595763683319091796875, 
            'max' => 4, 
            'step' => 0.1000000000000000055511151231257827021181583404541015625
          ]
        ], 
