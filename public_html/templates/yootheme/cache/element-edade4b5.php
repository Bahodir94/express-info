<?php // @file /home/s/surovov/vid.uz/public_html/templates/yootheme/vendor/yootheme/builder/elements/row/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      'fields' => ['layout', 'columns', 'fixed_width', 'gutter', 'divider', 'gutter_description', 'width', 'width_expand', 'height', 'margin', 'margin_remove_top', 'margin_remove_bottom', 'match', 'breakpoint', 'order_last', 'status', 'id', 'class']
    ]
  ]
];
