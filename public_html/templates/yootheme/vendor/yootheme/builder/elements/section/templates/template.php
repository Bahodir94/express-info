...
$el->attr([
    ...
    'class' => [
        ...
        'uk-preserve-color {@style: primary|secondary}' => $props['preserve_color'],
        'uk-{text_color} {@!style: primary|secondary}' => $props['image'] || $props['video'],
    ...
    'uk-scrollspy' => $props['animation'] ? [
        'target: [uk-scrollspy-class];',
        'cls: uk-animation-{animation};',
        'delay: {0};' => $props['animation_delay'] ? 200 : 'false',
    ] : false,

    'tm-header-transparent' => ['{header_transparent}'],
    'tm-header-transparent-placeholder' => $props['header_transparent'] && !$props['header_transparent_noplaceholder'],
]);
...
$container = $props['width'] || $props['video'] || $overlay
    ? $this->el('div', ['class' => [
        'uk-container {@width}',
        'uk-container-{width: xsmall|small|large|expand}',
...
<?= $el($props, !$image ? $attrs_section : []) ?>
    ...
    <?php endif ?>
        ...
        <?php endif ?>
            ...
            <?= $container ? $container($props, $builder->render($children)) : $builder->render($children) ?>
