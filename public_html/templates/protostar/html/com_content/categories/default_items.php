...
?>
	<?php foreach ($this->items[$this->parent->id] as $id => $item) : ?>
		<?php
    $item->numitems = MulticatsContentHelperRoute::getNumItems($item->id); // Multicats
		...
		<?php $class = ''; ?>
			<h3 class="page-header item-title">
				<a href="<?php echo JRoute::_(MulticatsContentHelperRoute::getCategoryRoute($item->id, $item->language)); ?>">
