		...
		<?php foreach ($this->items as $i => $article) : ?>
			...
			<td headers="categorylist_header_title" class="list-title">
				<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
					<a href="<?php echo JRoute::_(MulticatsContentHelperRoute::getArticleRoute($article->slug, $article->catid, $article->language)); //Multicats ?>">
              ...
              <?php foreach ($associations as $association) : ?>
				...
				<?php else : ?>
					...
					// Multicats          
          $link->setVar('return', base64_encode(MulticatsContentHelperRoute::getArticleRoute($article->slug, $article->catid, $article->language)));
					?>
