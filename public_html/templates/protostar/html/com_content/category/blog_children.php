...
require_once( JPATH_SITE.'/components/com_multicats/helpers/override/route.php' ); 
		...
		if ($this->params->get('show_empty_categories') || $child->numitems > 0) :
  		...
  		<div<?php echo $class; ?>>
              ...
              <?php echo $child->numitems; // Multicats ?> 
  				...
  				<?php endif; ?>
  				<a href="<?php echo JRoute::_(MulticatsContentHelperRoute::getCategoryRoute($child->id)); ?>">
