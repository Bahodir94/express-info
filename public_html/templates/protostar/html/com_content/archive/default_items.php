	...
	<?php foreach ($this->items as $i => $item) : ?>
			...
			<div class="page-header">
				<h2 itemprop="headline">
					<?php if ($params->get('link_titles')) : ?>
						<a href="<?php echo JRoute::_(MulticatsContentHelperRoute::getArticleRoute($item->slug, $item->catid, $item->language)); ?>" itemprop="url">
		...
		<?php if ($useDefList && ($info == 0 || $info == 2)) : ?>
			<div class="article-info muted">
              ...
              echo MulticatsContentHelper::getCategoryNames($item->id,$params->get('link_category'));
              ?>
						</div>
					</dd>
				<?php endif; ?>
